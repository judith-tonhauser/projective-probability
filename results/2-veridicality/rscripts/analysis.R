...
#   |:---------------|--------:|---------:|----:|-----:|
#   |b_Intercept     |     0.88|      0.01| 0.87|  0.89|
#   |b_phi_Intercept |     3.85|      0.24| 3.39|  4.32|
#   |b_zoi_Intercept |     0.38|      0.01| 0.35|  0.41|
#   |b_coi_Intercept |     0.98|      0.01| 0.97|  0.99|

# The .88 and 3.85 values are the mean and precision of the beta distribution that characterizes the bad controls that are not zeroes and ones -- this is a distribution heavily skewed towards 1
# The .38 value is the probability that an observation will be either 0 or 1, and of these 38% endpoint values, 98% (last value) are ones. So: as expected, the bad controls are heavily 1-skewed, see also this histogram:
...
# zoi ~ verb
# coi ~ verb
# Data: d (Number of observations: 6600) 
# Samples: 4 chains, each with iter = 2000; warmup = 1000; thin = 1;
# total post-warmup samples = 4000
# 
# Population-Level Effects: 
#   Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
# Intercept                 2.01      0.05     1.90     2.12       1107 1.00
# phi_Intercept             1.35      0.06     1.22     1.46       1192 1.00
# zoi_Intercept            -0.51      0.06    -0.63    -0.38       3417 1.00
# coi_Intercept             4.12      0.39     3.41     4.97       1294 1.00
# verbacknowledge          -1.67      0.09    -1.84    -1.48       2232 1.00
# verbadmit                -1.66      0.09    -1.85    -1.48       2474 1.00
# verbannounce             -1.88      0.10    -2.07    -1.69       2025 1.00
# verbannoyed              -1.72      0.09    -1.90    -1.53       2148 1.00
# verbbe_right_that        -0.80      0.11    -1.01    -0.59       2337 1.00
# verbconfess              -1.76      0.09    -1.94    -1.58       2429 1.00
# verbconfirm              -1.49      0.10    -1.68    -1.30       2108 1.00
# verbdemonstrate          -1.57      0.10    -1.76    -1.39       2407 1.00
# verbdiscover             -1.51      0.09    -1.69    -1.32       2654 1.00
# verbestablish            -1.57      0.09    -1.75    -1.38       2180 1.00
# verbhear                 -2.12      0.10    -2.32    -1.93       2709 1.00
# verbinform_Sam           -1.89      0.10    -2.08    -1.70       2384 1.00
# verbknow                 -1.29      0.10    -1.48    -1.10       2279 1.00
# verbpretend              -2.14      0.10    -2.34    -1.95       2791 1.00
# verbprove                -1.11      0.10    -1.30    -0.92       2492 1.00
# verbreveal               -1.69      0.10    -1.88    -1.51       2493 1.00
# verbsay                  -1.93      0.10    -2.12    -1.74       2333 1.00
# verbsee                  -1.38      0.10    -1.57    -1.19       2417 1.00
# verbsuggest              -2.11      0.10    -2.30    -1.92       2261 1.00
# verbthink                -2.11      0.10    -2.32    -1.91       2772 1.00
# phi_verbacknowledge      -0.86      0.10    -1.05    -0.67       2045 1.00
# phi_verbadmit            -0.91      0.10    -1.11    -0.72       2053 1.00
# phi_verbannounce         -1.05      0.09    -1.24    -0.87       1763 1.00
# phi_verbannoyed          -0.86      0.10    -1.05    -0.68       2186 1.00
# phi_verbbe_right_that    -0.71      0.11    -0.94    -0.49       2161 1.00
# phi_verbconfess          -0.90      0.10    -1.09    -0.72       2195 1.00
# phi_verbconfirm          -0.86      0.10    -1.06    -0.67       2109 1.00
# phi_verbdemonstrate      -0.84      0.10    -1.04    -0.64       2074 1.00
# phi_verbdiscover         -0.81      0.10    -1.00    -0.61       2157 1.00
# phi_verbestablish        -0.85      0.10    -1.05    -0.66       2083 1.00
# phi_verbhear             -1.08      0.10    -1.27    -0.88       2085 1.00
# phi_verbinform_Sam       -0.98      0.10    -1.17    -0.80       2211 1.00
# phi_verbknow             -0.71      0.10    -0.91    -0.50       2144 1.00
# phi_verbpretend          -1.06      0.10    -1.26    -0.88       2126 1.00
# phi_verbprove            -0.59      0.11    -0.81    -0.38       2151 1.00
# phi_verbreveal           -0.95      0.10    -1.14    -0.75       2117 1.00
# phi_verbsay              -1.09      0.10    -1.28    -0.90       2378 1.00
# phi_verbsee              -0.75      0.10    -0.95    -0.55       2467 1.00
# phi_verbsuggest          -0.94      0.10    -1.14    -0.75       1990 1.00
# phi_verbthink            -1.14      0.10    -1.33    -0.94       2194 1.00
# zoi_verbacknowledge      -1.73      0.22    -2.17    -1.33       4561 1.00
# zoi_verbadmit            -1.54      0.20    -1.94    -1.15       4436 1.00
# zoi_verbannounce         -1.33      0.19    -1.71    -0.97       4929 1.00
# zoi_verbannoyed          -1.46      0.19    -1.84    -1.09       4093 1.00
# zoi_verbbe_right_that    -0.46      0.15    -0.75    -0.19       4276 1.00
# zoi_verbconfess          -1.64      0.21    -2.06    -1.26       4206 1.00
# zoi_verbconfirm          -1.31      0.18    -1.67    -0.96       4500 1.00
# zoi_verbdemonstrate      -1.40      0.19    -1.76    -1.04       4704 1.00
# zoi_verbdiscover         -1.24      0.18    -1.60    -0.89       4397 1.00
# zoi_verbestablish        -1.50      0.20    -1.91    -1.11       4880 1.00
# zoi_verbhear             -1.05      0.17    -1.39    -0.72       4176 1.00
# zoi_verbinform_Sam       -1.21      0.18    -1.57    -0.87       4621 1.00
# zoi_verbknow             -1.16      0.18    -1.51    -0.82       3941 1.00
# zoi_verbpretend          -0.89      0.16    -1.20    -0.57       4459 1.00
# zoi_verbprove            -0.96      0.17    -1.29    -0.63       5256 1.00
# zoi_verbreveal           -1.50      0.20    -1.89    -1.13       4447 1.00
# zoi_verbsay              -1.03      0.17    -1.36    -0.70       4665 1.00
# zoi_verbsee              -1.22      0.18    -1.56    -0.88       4549 1.00
# zoi_verbsuggest          -0.91      0.17    -1.25    -0.57       4353 1.00
# zoi_verbthink            -0.91      0.16    -1.23    -0.59       3962 1.00
# coi_verbacknowledge      -3.22      0.59    -4.39    -2.04       1997 1.00
# coi_verbadmit            -2.98      0.58    -4.14    -1.82       2093 1.00
# coi_verbannounce         -4.13      0.51    -5.17    -3.17       1755 1.00
# coi_verbannoyed          -3.63      0.53    -4.71    -2.59       1525 1.00
# coi_verbbe_right_that     0.74      1.30    -1.32     3.73       2654 1.00
# coi_verbconfess          -3.11      0.58    -4.28    -1.99       2184 1.00
# coi_verbconfirm          -2.11      0.64    -3.34    -0.82       2209 1.00
# coi_verbdemonstrate      -2.99      0.57    -4.13    -1.92       1924 1.00
# coi_verbdiscover         -2.48      0.59    -3.61    -1.30       2099 1.00
# coi_verbestablish        -3.11      0.57    -4.25    -2.00       2174 1.00
# coi_verbhear             -5.02      0.51    -6.06    -4.09       1839 1.00
# coi_verbinform_Sam       -4.42      0.50    -5.45    -3.49       1809 1.00
# coi_verbknow             -2.40      0.58    -3.53    -1.26       1826 1.00
# coi_verbpretend          -5.32      0.51    -6.38    -4.38       1867 1.00
# coi_verbprove            -2.21      0.58    -3.33    -1.10       2210 1.00
# coi_verbreveal           -3.11      0.56    -4.22    -2.05       1915 1.00
# coi_verbsay              -4.60      0.48    -5.59    -3.72       1609 1.00
# coi_verbsee              -2.93      0.53    -4.01    -1.88       1890 1.00
# coi_verbsuggest          -5.19      0.51    -6.27    -4.24       1795 1.00
# coi_verbthink            -5.19      0.50    -6.21    -4.27       1828 1.01
# 
