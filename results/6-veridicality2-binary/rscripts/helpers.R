...
reshapeProjAI <- function(d)
{
  ...
  d$Trial2 = paste(d$List1,d$ListID1,d$ID1,d$Trigger1,d$OrderProjAI1,d$OrderItems1,d$OrderItemNum1,d$Response1,d$Projecting1,d$Content1,d$ContentType1,d$ContentNum1,d$TriggerClass1,d$CarolsUtt1,d$Question1,d$QuestionType1,sep = " ")
  d$Trial3 = paste(d$List2,d$ListID2,d$ID2,d$Trigger2,d$OrderProjAI2,d$OrderItems2,d$OrderItemNum2,d$Response2,d$Projecting2,d$Content2,d$ContentType2,d$ContentNum2,d$TriggerClass2,d$CarolsUtt2,d$Question2,d$QuestionType2,sep = " ")
  d$Trial4 = paste(d$List3,d$ListID3,d$ID3,d$Trigger3,d$OrderProjAI3,d$OrderItems3,d$OrderItemNum3,d$Response3,d$Projecting3,d$Content3,d$ContentType3,d$ContentNum3,d$TriggerClass3,d$CarolsUtt3,d$Question3,d$QuestionType3,sep = " ")
  d$Trial5 = paste(d$List4,d$ListID4,d$ID4,d$Trigger4,d$OrderProjAI4,d$OrderItems4,d$OrderItemNum4,d$Response4,d$Projecting4,d$Content4,d$ContentType4,d$ContentNum4,d$TriggerClass4,d$CarolsUtt4,d$Question4,d$QuestionType4,sep = " ")
  d$Trial6 = paste(d$List5,d$ListID5,d$ID5,d$Trigger5,d$OrderProjAI5,d$OrderItems5,d$OrderItemNum5,d$Response5,d$Projecting5,d$Content5,d$ContentType5,d$ContentNum5,d$TriggerClass5,d$CarolsUtt5,d$Question5,d$QuestionType5,sep = " ")
  d$Trial7 = paste(d$List6,d$ListID6,d$ID6,d$Trigger6,d$OrderProjAI6,d$OrderItems6,d$OrderItemNum6,d$Response6,d$Projecting6,d$Content6,d$ContentType6,d$ContentNum6,d$TriggerClass6,d$CarolsUtt6,d$Question6,d$QuestionType6,sep = " ")
  d$Trial8 = paste(d$List7,d$ListID7,d$ID7,d$Trigger7,d$OrderProjAI7,d$OrderItems7,d$OrderItemNum7,d$Response7,d$Projecting7,d$Content7,d$ContentType7,d$ContentNum7,d$TriggerClass7,d$CarolsUtt7,d$Question7,d$QuestionType7,sep = " ")
  d$Trial9 = paste(d$List8,d$ListID8,d$ID8,d$Trigger8,d$OrderProjAI8,d$OrderItems8,d$OrderItemNum8,d$Response8,d$Projecting8,d$Content8,d$ContentType8,d$ContentNum8,d$TriggerClass8,d$CarolsUtt8,d$Question8,d$QuestionType8,sep = " ")
  d$Trial10 = paste(d$List9,d$ListID9,d$ID9,d$Trigger9,d$OrderProjAI9,d$OrderItems9,d$OrderItemNum9,d$Response9,d$Projecting9,d$Content9,d$ContentType9,d$ContentNum9,d$TriggerClass9,d$CarolsUtt9,d$Question9,d$QuestionType9,sep = " ")
  d$Trial11 = paste(d$List10,d$ListID10,d$ID10,d$Trigger10,d$OrderProjAI10,d$OrderItems10,d$OrderItemNum10,d$Response10,d$Projecting10,d$Content10,d$ContentType10,d$ContentNum10,d$TriggerClass10,d$CarolsUtt10,d$Question10,d$QuestionType10,sep = " ")
  d$Trial12 = paste(d$List11,d$ListID11,d$ID11,d$Trigger11,d$OrderProjAI11,d$OrderItems11,d$OrderItemNum11,d$Response11,d$Projecting11,d$Content11,d$ContentType11,d$ContentNum11,d$TriggerClass11,d$CarolsUtt11,d$Question11,d$QuestionType11,sep = " ")
  d$Trial13 = paste(d$List12,d$ListID12,d$ID12,d$Trigger12,d$OrderProjAI12,d$OrderItems12,d$OrderItemNum12,d$Response12,d$Projecting12,d$Content12,d$ContentType12,d$ContentNum12,d$TriggerClass12,d$CarolsUtt12,d$Question12,d$QuestionType12,sep = " ")
  d$Trial14 = paste(d$List13,d$ListID13,d$ID13,d$Trigger13,d$OrderProjAI13,d$OrderItems13,d$OrderItemNum13,d$Response13,d$Projecting13,d$Content13,d$ContentType13,d$ContentNum13,d$TriggerClass13,d$CarolsUtt13,d$Question13,d$QuestionType13,sep = " ")
  d$Trial15 = paste(d$List14,d$ListID14,d$ID14,d$Trigger14,d$OrderProjAI14,d$OrderItems14,d$OrderItemNum14,d$Response14,d$Projecting14,d$Content14,d$ContentType14,d$ContentNum14,d$TriggerClass14,d$CarolsUtt14,d$Question14,d$QuestionType14,sep = " ")
  d$Trial16 = paste(d$List15,d$ListID15,d$ID15,d$Trigger15,d$OrderProjAI15,d$OrderItems15,d$OrderItemNum15,d$Response15,d$Projecting15,d$Content15,d$ContentType15,d$ContentNum15,d$TriggerClass15,d$CarolsUtt15,d$Question15,d$QuestionType15,sep = " ")
  d$Trial17 = paste(d$List16,d$ListID16,d$ID16,d$Trigger16,d$OrderProjAI16,d$OrderItems16,d$OrderItemNum16,d$Response16,d$Projecting16,d$Content16,d$ContentType16,d$ContentNum16,d$TriggerClass16,d$CarolsUtt16,d$Question16,d$QuestionType16,sep = " ")
  d$Trial18 = paste(d$List17,d$ListID17,d$ID17,d$Trigger17,d$OrderProjAI17,d$OrderItems17,d$OrderItemNum17,d$Response17,d$Projecting17,d$Content17,d$ContentType17,d$ContentNum17,d$TriggerClass17,d$CarolsUtt17,d$Question17,d$QuestionType17,sep = " ")
  d$Trial19 = paste(d$List18,d$ListID18,d$ID18,d$Trigger18,d$OrderProjAI18,d$OrderItems18,d$OrderItemNum18,d$Response18,d$Projecting18,d$Content18,d$ContentType18,d$ContentNum18,d$TriggerClass18,d$CarolsUtt18,d$Question18,d$QuestionType18,sep = " ")
  d$Trial20 = paste(d$List19,d$ListID19,d$ID19,d$Trigger19,d$OrderProjAI19,d$OrderItems19,d$OrderItemNum19,d$Response19,d$Projecting19,d$Content19,d$ContentType19,d$ContentNum19,d$TriggerClass19,d$CarolsUtt19,d$Question19,d$QuestionType19,sep = " ")
  d$Trial21 = paste(d$List20,d$ListID20,d$ID20,d$Trigger20,d$OrderProjAI20,d$OrderItems20,d$OrderItemNum20,d$Response20,d$Projecting20,d$Content20,d$ContentType20,d$ContentNum20,d$TriggerClass20,d$CarolsUtt20,d$Question20,d$QuestionType20,sep = " ")
  d$Trial22 = paste(d$List21,d$ListID21,d$ID21,d$Trigger21,d$OrderProjAI21,d$OrderItems21,d$OrderItemNum21,d$Response21,d$Projecting21,d$Content21,d$ContentType21,d$ContentNum21,d$TriggerClass21,d$CarolsUtt21,d$Question21,d$QuestionType21,sep = " ")
  d$Trial23 = paste(d$List22,d$ListID22,d$ID22,d$Trigger22,d$OrderProjAI22,d$OrderItems22,d$OrderItemNum22,d$Response22,d$Projecting22,d$Content22,d$ContentType22,d$ContentNum22,d$TriggerClass22,d$CarolsUtt22,d$Question22,d$QuestionType22,sep = " ")
  d$Trial24 = paste(d$List23,d$ListID23,d$ID23,d$Trigger23,d$OrderProjAI23,d$OrderItems23,d$OrderItemNum23,d$Response23,d$Projecting23,d$Content23,d$ContentType23,d$ContentNum23,d$TriggerClass23,d$CarolsUtt23,d$Question23,d$QuestionType23,sep = " ")
  d$Trial25 = paste(d$List24,d$ListID24,d$ID24,d$Trigger24,d$OrderProjAI24,d$OrderItems24,d$OrderItemNum24,d$Response24,d$Projecting24,d$Content24,d$ContentType24,d$ContentNum24,d$TriggerClass24,d$CarolsUtt24,d$Question24,d$QuestionType24,sep = " ")
  d$Trial26 = paste(d$List25,d$ListID25,d$ID25,d$Trigger25,d$OrderProjAI25,d$OrderItems25,d$OrderItemNum25,d$Response25,d$Projecting25,d$Content25,d$ContentType25,d$ContentNum25,d$TriggerClass25,d$CarolsUtt25,d$Question25,d$QuestionType25,sep = " ")
  d$Trial27 = paste(d$List26,d$ListID26,d$ID26,d$Trigger26,d$OrderProjAI26,d$OrderItems26,d$OrderItemNum26,d$Response26,d$Projecting26,d$Content26,d$ContentType26,d$ContentNum26,d$TriggerClass26,d$CarolsUtt26,d$Question26,d$QuestionType26,sep = " ")
  d$Trial28 = paste(d$List27,d$ListID27,d$ID27,d$Trigger27,d$OrderProjAI27,d$OrderItems27,d$OrderItemNum27,d$Response27,d$Projecting27,d$Content27,d$ContentType27,d$ContentNum27,d$TriggerClass27,d$CarolsUtt27,d$Question27,d$QuestionType27,sep = " ")
  return(d) 
}
