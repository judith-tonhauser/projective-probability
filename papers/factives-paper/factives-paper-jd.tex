...
Table \ref{tab:exp1amodelresults} shows maximum a posteriori (MAP) model estimates for projection ratings from Exp.~1a (left and middle column, mean $\mu$ and precision $\phi$) and Exp.~1b (right column, $\beta$)  with 95\% credible intervals.
