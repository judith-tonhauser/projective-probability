...
Where do we go from here? We see two broad ways forward. The first one is to keep looking for a class of factive predicates. Note that we have been careful to say that the results of our experiments are consistent with there not being a class of factive predicates, not that our results conclusively show that there is no class of factive predicates. In section \ref{s41}, we discuss what evidence for a class of factive predicates might look like. The second way forward is to embrace the results reported here and give up on the assumption that there is a coherent class of factive predicates (see also \citealt{karttunen2016} and \citealt{djaerv-thesis} for such moves). In section \ref{s42}, we discuss what this move would mean for one of the areas in which factivity has played a central role in theorizing, namely projection analyses. 
