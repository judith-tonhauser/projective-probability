...
One reason for the lack of consensus about which predicates are factive is disagreement about their definition. As mentioned above, \citealt{kiparsky-kiparsky70} defined factive predicates as those for which the CC is presupposed (see also, e.g.\ \citealt{karttunen71-implicative,karttunen71b}), with projection diagnosing presupposed CCs. Thus, on this definition, a predicate is factive if and only if the speaker is typically committed to the truth of the CC not only in affirmative matrix sentences, but also in negated and polar question variants. More recent work, however, assumes that the CC of a factive predicate is not only presupposed but also entailed (e.g.\ \citealt[119-123]{gazdar79a}, \citealt[139]{schlenker10}, \citealt{abrusan2011}, \citealt[71]{anand-hacquard2014}, \citealt[fn.7]{spector-egre2015}).\footnote{For instance, according to \citealt[66f.]{beaver01}, \citealt[119-123]{gazdar79a} `describes the inferences associated with factive verbs $[$\dots$]$ as being indefeasible in simple affirmative sentences', that is, `entailments'. And \citet[139]{schlenker10}, in discussing CCs, pointed to `the pattern of inference which is characteristic of presuppositions: an entailment of the positive sentence is preserved under negation and in questions'. Authors are not always clear about which definition they subscribe to. For instance, \citet[355]{ccmg90} used {\em realize} to illustrate that `[a] sentence can both entail and presuppose another sentence': {\em Joan realizes that syntax deals with sentence structure} `both entails and presupposes'  ({\em ibid.}) that syntax deals with sentence structure. It is not clear, however, whether they assumed this pattern for factive predicates more generally or whether they assumed that a predicate is factive as along as its CC is presupposed.} In other words, for a predicate to be factive, not only does the speaker have to presuppose the CC, but the truth of the CC also has to be indefeasibly inferred from affirmative matrix sentences; that is, the truth of the CC has to follow for any competent language user, not just the speaker, from a true affirmative matrix sentence in which the CC is embedded under the predicate.\footnote{A content $c$ is an entailment of sentence S if and only if $c$ is the case whenever S is true, that is, if and only if $c$ is indefeasibly implied by S. For instance, the content that Sam has a cat is an entailment of the sentence {\em Sam has a white cat}. A hallmark of presupposed content is projection: A content $c$ is a presupposition if $c$ is typically implied by an utterance of S as well as by utterances of so-called family-of-sentences variants of S, including the polar question variant of S or the negation of S (see e.g.\ \citealt[\S3.1]{ccmg90}). For instance, the content that Sam has a parrot is typically implied not just by an utterance of the sentence {\em Sam's parrot is loud}, but also by utterances of the polar question variant {\em Is Sam's parrot loud?} and the negated variant {\em Sam's parrot isn't loud}. (See section \ref{s12} for how to distinguish presuppositions from conventional implicatures, another type of projective content.) From the definitions of presupposed and entailed content, and from the ways in which projection and entailment are diagnosed, it follows that presupposed content may, but need not be entailed, and entailed content may, but need not be, presupposed. Thus, content that is implied by an unembedded sentence may be merely entailed, merely presupposed, or both entailed and presupposed.} The two definitions are given in \ref{def}.
...
\vspace*{.3cm}
\noindent
$<$ INSERT FIGURES 18a-f (2 columns, 3 rows) ABOUT HERE $>$
\vspace*{.3cm}
...
\bibitem[{Abrus{\'a}n(2011)}]{abrusan2011}
\textsc{Abrus{\'a}n, M{\'a}rta}. 2011.
\newblock Predicting the presuppositions of soft triggers.
\newblock \emph{Linguistics \& Philosophy} 34.491--535.

\bibitem[{Abrus\'an(2014)}]{abrusan2014}
\textsc{Abrus\'an, M\'arta}. 2014.
\newblock \emph{Weak island semantics}.
\newblock New York: Oxford University Press.

\bibitem[{Abrus{\'a}n(2016)}]{abrusan2016}
\textsc{Abrus{\'a}n, M{\'a}rta}. 2016.
\newblock Presupposition cancellation: {E}xplaining the `soft-hard' trigger
  distinction.
\newblock \emph{Natural Language Semantics} 24.165--202.

\bibitem[{Abusch(2010)}]{abusch10}
\textsc{Abusch, Dorit}. 2010.
\newblock Presupposition triggering from alternatives.
\newblock \emph{Journal of Semantics} 27.37--80.

\bibitem[{Anand et~al.(2019)Anand and colleagues}]{anand-etal2019}
\textsc{Anand, Pranav}; \textsc{Jane Grimshaw}; and \textsc{Valentine
  Hacquard}. 2019.
\newblock Sentence embedding predicates, factivity and subjects.
\newblock \emph{Tokens of meaning: {P}apers in honor of {L}auri {K}arttunen},
  ed.~by Cleo Condoravdi and Tracy {Holloway King}. Stanford: CSLI
  Publications.

\bibitem[{Anand \& Hacquard(2014)Anand and Hacquard}]{anand-hacquard2014}
\textsc{Anand, Pranav}, and \textsc{Valentine Hacquard}. 2014.
\newblock Factivity, belief and discourse.
\newblock \emph{The art and craft of semantics: A festschrift for {I}rene
  {H}eim}, ed.~by Luka Crni\v{c} and Uli Sauerland, 69--90. MIT Working Papers
  in Linguistics.
\urlprefix\url{https://semanticsarchive.net/Archive/jZiNmM4N/}.

\bibitem[{Anderson(1986)}]{anderson86}
\textsc{Anderson, Lloyd~B.} 1986.
\newblock Evidentials, paths of change, and mental maps: {T}ypologically
  regular asymmetries.
\newblock \emph{Evidentiality: {T}he linguistic coding of epistemology}, ed.~by
  Wallace~L. Chafe and Johanna Nichols, 273--312. New Jersey: Ablex Publishing
  Corporation.

\bibitem[{Aravind \& Hackl(2017)Aravind and Hackl}]{aravind-hackl2017}
\textsc{Aravind, Athulya}, and \textsc{Martin Hackl}. 2017.
\newblock Factivity and at-issueness in the acquisition of {\em forget} and
  {\em remember}.
\newblock \emph{41st annual boston university conference on language
  development}, 46--59.

\bibitem[{Beaver(2001)}]{beaver01}
\textsc{Beaver, David}. 2001.
\newblock \emph{Presupposition and assertion in dynamic semantics}.
\newblock Stanford, CA: CSLI Publications.

\bibitem[{Beaver(2010)}]{beaver-belly}
\textsc{Beaver, David}. 2010.
\newblock Have you noticed that your belly button lint colour is related to the
  colour of your clothing?
\newblock \emph{Presuppositions and discourse: {E}ssays offered to {H}ans
  {K}amp}, ed.~by Rainer B\"auerle, Uwe Reyle, and Thomas Zimmermann, 65--99.
  Oxford: Elsevier.

\bibitem[{Beaver \& Geurts(2014)Beaver and Geurts}]{beaver-geurts-sep}
\textsc{Beaver, David}, and \textsc{Bart Geurts}. 2014.
\newblock Presupposition.
\newblock \emph{The {S}tanford {E}ncyclopedia of {P}hilosophy}, ed.~by {Edward
  N.} Zalta. Stanford University.

\bibitem[{Benaglia et~al.(2009)Benaglia and colleagues}]{benaglia2009}
\textsc{Benaglia, Tatiana}; \textsc{Didier Chauveau}; \textsc{David~R. Hunter};
  and \textsc{Derek Young}. 2009.
\newblock {mixtools}: An {R} package for analyzing finite mixture models.
\newblock \emph{Journal of Statistical Software} 32.1--29.
\urlprefix\url{http://www.jstatsoft.org/v32/i06/}.

\bibitem[{Bergen et~al.(2016)Bergen and colleagues}]{bergen2016}
\textsc{Bergen, Leon}; \textsc{Roger Levy}; and \textsc{Noah Goodman}. 2016.
\newblock Pragmatic reasoning through semantic inference.
\newblock \emph{Semantics and Pragmatics} 9.Article 20.

\bibitem[{B\"urkner(2017)}]{buerkner2017}
\textsc{B\"urkner, Paul-Christian}. 2017.
\newblock {brms}: An {R} package for bayesian multilevel models using {Stan}.
\newblock \emph{Journal of Statistical Software} 80.1--28.

\bibitem[{Chierchia \& McConnell-Ginet(1990)Chierchia and
  McConnell-Ginet}]{ccmg90}
\textsc{Chierchia, Gennaro}, and \textsc{Sally McConnell-Ginet}. 1990.
\newblock \emph{Meaning and grammar}.
\newblock Cambridge, MA: MIT Press.

\bibitem[{Cremers(2018)}]{cremers2018}
\textsc{Cremers, Alexandre}. 2018.
\newblock Plurality effects in an exhaustification-based theory of embedded
  questions.
\newblock \emph{Natural Language Semantics} 26.193--251.

\bibitem[{Cummins \& Rohde(2015)Cummins and Rohde}]{cummins-rohde2015}
\textsc{Cummins, Chris}, and \textsc{Hannah Rohde}. 2015.
\newblock Evoking context with contrastive stress: {E}ffects on pragmatic
  enrichment.
\newblock \emph{Frontiers in Psychology} 6.Article 1779.

\bibitem[{{de Marneffe} et~al.(2019){de Marneffe} and
  colleagues}]{demarneffe-etal-sub23}
\textsc{{de Marneffe}, Marie}; \textsc{Mandy Simons}; and \textsc{Judith
  Tonhauser}. 2019.
\newblock The {C}ommitment{B}ank: {I}nvestigating projection in naturally
  occurring discourse.
\newblock \emph{Sinn und Bedeutung} 23.107--124.

\bibitem[{{de Villiers}(2005)}]{devillers2005}
\textsc{{de Villiers}, Jill~G.} 2005.
\newblock Can language acquisition give children a point of view.
\newblock \emph{Why language acquisition matters for theory of mind}, ed.~by
  {Janet Wilde} Astington and {Jodie A} Baird, 186--219. Oxford: Oxford
  University Press.

\bibitem[{Degen \& Tonhauser(2021)Degen and
  Tonhauser}]{degen-tonhauser-openmind}
\textsc{Degen, Judith}, and \textsc{Judith Tonhauser}. 2021.
\newblock {Prior Beliefs Modulate Projection}.
\newblock \emph{Open Mind} 5.59--70.
\urlprefix\url{https://doi.org/10.1162/opmi\_a\_00042}.

\bibitem[{Dj\"arv(2019)}]{djaerv-thesis}
\textsc{Dj\"arv, Kajsa}. 2019.
\newblock \emph{Factive and assertive attitude reports}.
\newblock University of Pennsylvania dissertation.

\bibitem[{Dj\"arv \& Bacovcin(2017)Dj\"arv and
  Bacovcin}]{djaerv-bacovcin-salt27}
\textsc{Dj\"arv, Kajsa}, and \textsc{{Hezekiah Akiva} Bacovcin}. 2017.
\newblock Prosodic effects on factive presupposition projection.
\newblock \emph{Semantics and Linguistic Theory} 27.116--133.

\bibitem[{Dj\"arv et~al.(2016)Dj\"arv and colleagues}]{djaerv-etal2016}
\textsc{Dj\"arv, Kajsa}; \textsc{J\'er\'emy Zehr}; and \textsc{Florian
  Schwarz}. 2016.
\newblock Cognitive vs.\ emotive factives: {A}n experimental differentiation.
\newblock \emph{Sinn und {B}edeutung 21}, 367--385.

\bibitem[{Egr\'e(2008)}]{egre2008}
\textsc{Egr\'e, Paul}. 2008.
\newblock Question-embedding and factivity.
\newblock \emph{Grazer philosophische studien}, ed.~by L~Lihoreau, 85--125.
  Amsterdam: Rodopi.

\bibitem[{Gazdar(1979{\natexlab{a}})}]{gazdar79a}
\textsc{Gazdar, Gerald}. 1979{\natexlab{a}}.
\newblock \emph{Pragmatics: Implicature, presuppositions, and logical form}.
\newblock New York: Academic Press.

\bibitem[{Gazdar(1979{\natexlab{b}})}]{gazdar79b}
\textsc{Gazdar, Gerald}. 1979{\natexlab{b}}.
\newblock A solution to the projection problem.
\newblock \emph{Syntax and semantics 11: Presupposition}, ed.~by Choon-Kyu Oh
  and David Dinneen, 57--89. New York: Academic Press.

\bibitem[{Gelman \& Hill(2006)Gelman and Hill}]{gelman2006}
\textsc{Gelman, Andrew}, and \textsc{Jennifer Hill}. 2006.
\newblock \emph{Data analysis using regression and multilevel/hierarchical
  models}.
\newblock Cambridge University Press.

\bibitem[{Giannakidou(1998)}]{giannakidou1998}
\textsc{Giannakidou, Anastasia}. 1998.
\newblock \emph{Polarity sensitivity as (non)veridical dependency}.
\newblock Dordrecht: John Benjamins.

\bibitem[{Giannakidou(2001)}]{giannakidou2001}
\textsc{Giannakidou, Anastasia}. 2001.
\newblock The meaning of free choice.
\newblock \emph{Linguistics and Philosophy} 24.659--735.

\bibitem[{Giannakidou \& Mari(2015)Giannakidou and Mari}]{giannakidou-mari2015}
\textsc{Giannakidou, Anastasia}, and \textsc{Alda Mari}. 2015.
\newblock Mixed (non)veridicality and mood choice with emotive verbs.
\newblock \emph{Chicago Linguistic Society} 51.181--195.

\bibitem[{Giv\'on(1995)}]{givon95}
\textsc{Giv\'on, Talmy}. 1995.
\newblock \emph{Functionalism and grammar}.
\newblock Amsterdam: John Benjamins.

\bibitem[{Guerzoni \& Sharvit(2007)Guerzoni and Sharvit}]{guerzoni-sharvit2007}
\textsc{Guerzoni, Elena}, and \textsc{Yael Sharvit}. 2007.
\newblock A question of strength: {O}n {N}{P}{I}s in interrogative clauses.
\newblock \emph{Linguistics \& Philosophy} 30.361--391.

\bibitem[{Hazlett(2010)}]{hazlett2010}
\textsc{Hazlett, Allan}. 2010.
\newblock The myth of factive verbs.
\newblock \emph{Philosophy and Phenomenological Research} 80.497--522.

\bibitem[{Heim(1983)}]{heim83}
\textsc{Heim, Irene}. 1983.
\newblock On the projection problem for presuppositions.
\newblock \emph{West Coast Conference on Formal Linguistics} 2.114--125.

\bibitem[{Heim(1992)}]{heim92}
\textsc{Heim, Irene}. 1992.
\newblock Presupposition projection and the semantics of attitude verbs.
\newblock \emph{Journal of Semantics} 9.183--221.

\bibitem[{Heycock(2006)}]{heycock2006}
\textsc{Heycock, Caroline}. 2006.
\newblock Embedded root phenomena.
\newblock \emph{The blackwell companion to syntax}, ed.~by Martin Everaert and
  Henk {van Riemsdijk}, 174--209. Wiley.

\bibitem[{Hintikka(1975)}]{hintikka1975}
\textsc{Hintikka, Jaakko}. 1975.
\newblock Different constructions in terms of the basic epistemological verbs:
  {A} survey of some problems and proposals.
\newblock \emph{The intentions of intentionality and other new models for
  modalities}, ed.~by Jaakko Hintikka, 1--25. Dordrecht: Reidel.

\bibitem[{Hofmeister \& Sag(2010)Hofmeister and Sag}]{hofmeister2010}
\textsc{Hofmeister, Philip}, and \textsc{Ivan~A Sag}. 2010.
\newblock Cognitive constraints and island effects.
\newblock \emph{Language} 86.366--415.

\bibitem[{Hukari \& Levine(1995)Hukari and Levine}]{hukari-levine1995}
\textsc{Hukari, Thomas}, and \textsc{Robert Levine}. 1995.
\newblock Adjunct extraction.
\newblock \emph{Natural Language and Linguistic Theory} 31.195--226.

\bibitem[{Jacobs et~al.(1991)Jacobs and colleagues}]{jacobs1991}
\textsc{Jacobs, Robert~a.}; \textsc{Michael~I. Jordan}; \textsc{Steven~J.
  Nowlan}; and \textsc{Geoffrey~E. Hinton}. 1991.
\newblock {Adaptive Mixtures of Local Experts}.
\newblock \emph{Neural Computation} 3.79--87.
\urlprefix\url{http://www.mitpressjournals.org/doi/abs/10.1162/neco.1991.3.1.79}.

\bibitem[{Jaynes \& Kempthorne(1976)Jaynes and Kempthorne}]{Jaynes1976}
\textsc{Jaynes, Edwin}, and \textsc{Oscar Kempthorne}. 1976.
...
\newblock \emph{Foundations of probability theory, statistical inference, and
  statistical theories of science}, ed.~by William~Leonard Harper and
  Clifford~Alan Hooker, 175--257. Dordrecht: Springer Netherlands.

\bibitem[{Karttunen(1971{\natexlab{a}})}]{karttunen71-implicative}
\textsc{Karttunen, Lauri}. 1971{\natexlab{a}}.
\newblock Implicative verbs.
\newblock \emph{Language} 47.340--358.

\bibitem[{Karttunen(1971{\natexlab{b}})}]{karttunen71b}
\textsc{Karttunen, Lauri}. 1971{\natexlab{b}}.
\newblock Some observations on factivity.
\newblock \emph{Papers in Linguistics} 4.55--69.

\bibitem[{Karttunen(2016)}]{karttunen2016}
\textsc{Karttunen, Lauri}. 2016.
\newblock Presupposition: {W}hat went wrong?
\newblock \emph{Proceedings of {Semantics and Linguistic Theory (SALT) XXVI}},
  705--731. Ithaca, NY: CLC Publications.

\bibitem[{Karttunen \& Peters(1979)Karttunen and Peters}]{karttunen-peters79}
\textsc{Karttunen, Lauri}, and \textsc{Stanley Peters}. 1979.
\newblock Conventional implicature.
\newblock \emph{Presuppositions}, ed.~by Choon-Kyu Oh and David~A. Dinneen,
  Syntax and Semantics Vol.11, 1--56. New York: Academic Press.

\bibitem[{Karttunen et~al.(2014)Karttunen and colleagues}]{karttunen-etal2014}
\textsc{Karttunen, Lauri}; \textsc{Stanley Peters}; \textsc{Annie Zaenen}; and
  \textsc{Cleo Condoravdi}. 2014.
\newblock The chameleon-like nature of evaluative adjectives.
\newblock \emph{Empirical Issues in Syntax and Semantics} 10.233--250.

\bibitem[{Karttunen \& Zaenen(2005)Karttunen and Zaenen}]{karttunen-zaenen2005}
\textsc{Karttunen, Lauri}, and \textsc{Annie Zaenen}. 2005.
\newblock Veridicity.
\newblock \emph{Annotating, extracting and reasoning about time and events},
  ed.~by Graham Katz, James Pustejovsky, and Frank Schilder, no. 05151 in
  Dagstuhl Seminar Proceedings. Internationales Begegnungs- und
  Forschungszentrum f{\"u}r Informatik (IBFI), Schloss Dagstuhl, Germany.

\bibitem[{Kastner(2015)}]{kastner2015}
\textsc{Kastner, Itamar}. 2015.
\newblock Factivity mirrors interpretation: {T}he selectional requirements of
  presuppositional verbs.
\newblock \emph{Lingua} 164.156--188.

\bibitem[{Keller(2000)}]{keller2000}
\textsc{Keller, Frank}. 2000.
\newblock \emph{Gradience in grammar: Experimental and computational aspects of
  degrees of grammaticality}.
\newblock University of Edinburgh dissertation.

\bibitem[{Kiparsky \& Kiparsky(1970)Kiparsky and
  Kiparsky}]{kiparsky-kiparsky70}
\textsc{Kiparsky, Paul}, and \textsc{Carol Kiparsky}. 1970.
\newblock Fact.
\newblock \emph{Progress in linguistics}, ed.~by Manfred Bierwisch and {Karl
  Erich} Heidolph, 143--173. The Hague: Mouton.

\bibitem[{Klein(1975)}]{klein1975}
\textsc{Klein, Ewan}. 1975.
\newblock Two sorts of factive predicates.
\newblock Pragmatics Microfiche it 1.1. frames B5?C14.

\bibitem[{Landau(2001)}]{landau2001}
\textsc{Landau, Idan}. 2001.
\newblock \emph{Elements of control: {S}tructure and meaning in infinitival
  constructions}.
\newblock Springer.

\bibitem[{Langendoen \& Savin(1971)Langendoen and Savin}]{langendoen-savin71}
\textsc{Langendoen, Terry}, and \textsc{Harris Savin}. 1971.
\newblock The projection problem for presuppositions.
\newblock \emph{{Studies in Linguistic Semantics}}, ed.~by Charles Fillmore and
  Terry Langendoen, 54--60. New York: Holt, Rinehart and Winston.

\bibitem[{Lasersohn(2009)}]{lasersohn2009}
\textsc{Lasersohn, Peter}. 2009.
\newblock Relative truth, speaker commitment, and control of implicit
  arguments.
\newblock \emph{Synthese} 166.359--374.

\bibitem[{Lau et~al.(2014)Lau and colleagues}]{lau2014}
\textsc{Lau, Jey~Han}; \textsc{Alexander Clark}; and \textsc{Shalom Lappin}.
  2014.
\newblock Measuring gradience in speaker's grammaticality judgements.
\newblock \emph{Proceedings of the annual meeting of the cognitive science
  society}, vol.~36.

\bibitem[{Lau et~al.(2017)Lau and colleagues}]{lau2017}
\textsc{Lau, Jey~Han}; \textsc{Alexander Clark}; and \textsc{Shalom Lappin}.
  2017.
\newblock Grammaticality, acceptability, and probability: A probabilistic view
  of linguistic knowledge.
\newblock \emph{Cognitive science} 41.1202--1241.

\bibitem[{Lorson(2018)}]{lorson2018}
\textsc{Lorson, Alexandra}. 2018.
\newblock The influence of world knowledge on projectivity.
\newblock M.A.\ thesis, University of Potsdam.

\bibitem[{Mahler(2019)}]{mahler-nels}
\textsc{Mahler, Taylor}. 2019.
\newblock Does at-issueness predict projection? {I}t's complicated!
\newblock \emph{North East Linguistic Society} 49.245--255.

\bibitem[{Mahler(2020)}]{mahler2020}
\textsc{Mahler, Taylor}. 2020.
\newblock The social component of projection behavior of clausal complements.
\newblock \emph{Linguistic Society of America} 5.777--791.

\bibitem[{Mahler et~al.(2020)Mahler and colleagues}]{mahler-etal2020}
\textsc{Mahler, Taylor}; \textsc{Marie-Catherine de~Marneffe}; and
  \textsc{Catherine Lai}. 2020.
\newblock The prosody of presupposition projection in naturally-occurring
  utterances.
\newblock \emph{Sinn und Bedeutung} 24.20--37.

\bibitem[{de~Marneffe et~al.(2012)de~Marneffe and
  colleagues}]{demarneffe-etal2012}
\textsc{de~Marneffe, Marie-Catherine}; \textsc{{Christopher D.} Manning}; and
  \textsc{Christopher Potts}. 2012.
\newblock Did it happen? {T}he pragmatic complexity of veridicality assessment.
\newblock \emph{Computational Linguistics} 38.301--333.

\bibitem[{Morey et~al.(2016)Morey and colleagues}]{Morey2016}
\textsc{Morey, Richard~D.}; \textsc{Rink Hoekstra}; \textsc{Jeffrey~N. Rouder};
  \textsc{Michael~D. Lee}; and \textsc{Eric~J. Wagenmakers}. 2016.
\newblock {The fallacy of placing confidence in confidence intervals}.
\newblock \emph{Psychonomic Bulletin and Review} 23.103--123.

\bibitem[{Nicenboim \& Vasishth(2016)Nicenboim and Vasishth}]{Nicenboim2016}
\textsc{Nicenboim, Bruno}, and \textsc{Shravan Vasishth}. 2016.
\newblock {Statistical methods for linguistic research: Foundational Ideas,
  Part II}.
\newblock \emph{Linguistics and Language Compass} 10.591--613.

\bibitem[{Pavlick \& Kwiatkowski(2019)Pavlick and
  Kwiatkowski}]{pavlick-kwiatkowski2019}
\textsc{Pavlick, Ellie}, and \textsc{Tom Kwiatkowski}. 2019.
\newblock Inherent disagreements in human textual inferences.
\newblock \emph{Transactions of the association for computational linguistics},
  677--694. Association for Computational Linguistics.

\bibitem[{Pinker(1994)}]{pinker94}
\textsc{Pinker, Steven}. 1994.
\newblock \emph{The language instinct}.
\newblock New York: HarperPerennial.
\newblock First published in 1994 by William Morrow and Co.\ (New York).

\bibitem[{Potts(2005)}]{potts05}
\textsc{Potts, Christopher}. 2005.
\newblock \emph{The {L}ogic of {C}onventional {I}mplicatures}.
\newblock Oxford: Oxford University Press.

\bibitem[{Qing et~al.(2016)Qing and colleagues}]{qing-etal2016}
\textsc{Qing, Ciyang}; \textsc{Noah~D Goodman}; and \textsc{Daniel Lassiter}.
  2016.
\newblock A rational speech-act model of projective content.
\newblock \emph{{Proceedings of the 38th Annual Meeting of the Cognitive
  Science Society}}, 1110--1115. Austin, TX: Cognitive Science Society.

\bibitem[{{R Core Team}(2016)}]{R}
\textsc{{R Core Team}}. 2016.
\newblock \emph{R: A language and environment for statistical computing}.
\newblock R Foundation for Statistical Computing, Vienna, Austria.
\urlprefix\url{https://www.R-project.org/}.

\bibitem[{Richardson \& Green(1997)Richardson and Green}]{richardson1997}
\textsc{Richardson, Sylvia}, and \textsc{Peter~J. Green}. 1997.
\newblock {On Bayesian Analysis of Mixtures with an Unknown Number of
  Components}.
\newblock \emph{Journal of the Royal Statistical Society} 59.731--792.

\bibitem[{Romoli(2015)}]{romoli2015}
\textsc{Romoli, Jacopo}. 2015.
\newblock The presuppositions of soft triggers are obligatory scalar
  implicatures.
\newblock \emph{Journal of Semantics} 32.173--291.

\bibitem[{Rooryck(2000)}]{rooryck2000}
\textsc{Rooryck, Johan}. 2000.
\newblock \emph{Configurations of sentential complementation}.
\newblock London: Routledge.

\bibitem[{Ross \& Pavlick(2019)Ross and Pavlick}]{ross-pavlick2019}
\textsc{Ross, Alexis}, and \textsc{Ellie Pavlick}. 2019.
\newblock How well do {N}{L}{I} models capture verb veridicality?
\newblock \emph{Proceedings of the 2019 conference on empirical methods in
  natural language processing and the 9th international joint conference on
  natural language processing}, 2230--2240. Association for Computational
  Linguistics.

\bibitem[{van~der Sandt(1992)}]{vds92}
\textsc{van~der Sandt, Rob}. 1992.
\newblock Presupposition projection as anaphora resolution.
\newblock \emph{Journal of Semantics} 9.333--377.

\bibitem[{Schlenker(2003{\natexlab{a}})}]{schlenker03}
\textsc{Schlenker, Philippe}. 2003{\natexlab{a}}.
\newblock A plea for monsters.
\newblock \emph{Linguistics \& Philosophy} 26.29--120.

\bibitem[{Schlenker(2010)}]{schlenker10}
\textsc{Schlenker, Philippe}. 2010.
\newblock Local contexts and local meanings.
\newblock \emph{Philosophical Studies} 151.115--142.

\bibitem[{Schlenker(2003{\natexlab{b}})}]{schlenker2003}
\textsc{Schlenker, Phillipe}. 2003{\natexlab{b}}.
\newblock The lazy {F}renchman's approach to the subjunctive.
\newblock \emph{Proceedings of {R}omance languages and linguistic theory},
  269--309.

\bibitem[{Scrucca et~al.(2016)Scrucca and colleagues}]{scrucca2016}
\textsc{Scrucca, Luca}; \textsc{Michael Fop}; \textsc{T.~Brendan Murphy}; and
  \textsc{Adrian~E. Raftery}. 2016.
\newblock {mclust} 5: {C}lustering, classification and density estimation using
  {G}aussian finite mixture models.
\newblock \emph{The {R} Journal} 8.289--317.
\urlprefix\url{https://doi.org/10.32614/RJ-2016-021}.

\bibitem[{Simons(2007)}]{simons07}
\textsc{Simons, Mandy}. 2007.
\newblock Observations on embedding verbs, evidentiality, and presupposition.
\newblock \emph{Lingua} 117.1034--1056.

\bibitem[{Simons et~al.(2017)Simons and colleagues}]{best-question}
\textsc{Simons, Mandy}; \textsc{David Beaver}; \textsc{Craige Roberts}; and
  \textsc{Judith Tonhauser}. 2017.
\newblock The {B}est {Q}uestion: Explaining the projection behavior of factive
  verbs.
\newblock \emph{Discourse Processes} 3.187--206.

\bibitem[{Simons et~al.(2010)Simons and colleagues}]{brst-salt10}
\textsc{Simons, Mandy}; \textsc{Judith Tonhauser}; \textsc{David Beaver}; and
  \textsc{Craige Roberts}. 2010.
\newblock What projects and why.
\newblock \emph{Semantics and Linguistic Theory} 11.309--327.

\bibitem[{Smith \& Hall(2011)Smith and Hall}]{smith-hall11}
\textsc{Smith, {E.\ Allyn}}, and \textsc{Kathleen~Currie Hall}. 2011.
\newblock Projection diversity: {E}xperimental evidence.
\newblock \emph{2011 {ESSLLI} Workshop on Projective Content.}, 156--170.

\bibitem[{Smithson \& Verkuilen(2006)Smithson and Verkuilen}]{smithson2006}
\textsc{Smithson, Michael}, and \textsc{Jay Verkuilen}. 2006.
\newblock A better lemon squeezer? {M}aximum-likelihood regression with
  beta-distributed dependent variables.
\newblock \emph{Psychological Methods} 11.54.

\bibitem[{Sorace \& Keller(2005)Sorace and Keller}]{sorace2005}
\textsc{Sorace, Antonella}, and \textsc{Frank Keller}. 2005.
\newblock Gradience in linguistic data.
\newblock \emph{Lingua} 115.1497--1524.

\bibitem[{Spector \& Egr\'e(2015)Spector and Egr\'e}]{spector-egre2015}
\textsc{Spector, Benjamin}, and \textsc{Paul Egr\'e}. 2015.
\newblock A uniform semantics for embedding interrogatives: {\em {A}n} answer,
  not necessarily {\em the} answer.
\newblock \emph{Synthese} 192.1729--1784.

\bibitem[{Sprouse(2007)}]{sprouse2007}
\textsc{Sprouse, Jon}. 2007.
\newblock Continuous acceptability, categorical grammaticality, and
  experimental syntax.
\newblock \emph{Biolinguistics} 1.123--134.

\bibitem[{Sprouse \& Almeida(2013)Sprouse and Almeida}]{sprouse2013}
\textsc{Sprouse, Jon}, and \textsc{Diogo Almeida}. 2013.
\newblock The role of experimental syntax in an integrated cognitive science of
  language.
\newblock \emph{The Cambridge handbook of biolinguistics}, 181--202.

\bibitem[{Stevens et~al.(2017)Stevens and colleagues}]{stevens-etal2017}
\textsc{Stevens, {Jon Scott}}; \textsc{Marie-Catherine {de Marneffe}};
  \textsc{{Shari R.} Speer}; and \textsc{Judith Tonhauser}. 2017.
\newblock Rational use of prosody predicts projectivity in manner adverb
  utterances.
\newblock \emph{Annual Meeting of the Cognitive Science Society} 39.1144--1149.

\bibitem[{Swanson(2012)}]{swanson2012}
\textsc{Swanson, Eric}. 2012.
\newblock Propositional attitudes.
\newblock \emph{Semantics: An international handbook of natural language
  meaning}, ed.~by Klaus von Heusinger, Claudia Maienborn, and Paul Portner,
  vol.~2, 1538--1561. Berlin: Mouton de Gruyter.

\bibitem[{Tonhauser(2016)}]{tonhauser-salt26}
\textsc{Tonhauser, Judith}. 2016.
\newblock Prosodic cues to speaker commitment.
\newblock \emph{Semantics and Linguistic Theory} 26.934--960.

\bibitem[{Tonhauser(2020)}]{tonhauser-guarani-variability}
\textsc{Tonhauser, Judith}. 2020.
\newblock Projection variability in {P}araguayan {G}uaran\'i.
\newblock \emph{Natural Language and Linguistic Theory} 38.1263--1302.

\bibitem[{Tonhauser et~al.(2018)Tonhauser and colleagues}]{tbd-variability}
\textsc{Tonhauser, Judith}; \textsc{David Beaver}; and \textsc{Judith Degen}.
  2018.
\newblock How projective is projective content? {G}radience in projectivity and
  at-issueness.
\newblock \emph{Journal of Semantics} 35.495--542.

\bibitem[{Tonhauser et~al.(2013)Tonhauser and colleagues}]{brst-lang11}
\textsc{Tonhauser, Judith}; \textsc{David Beaver}; \textsc{Craige Roberts}; and
  \textsc{Mandy Simons}. 2013.
\newblock Toward a taxonomy of projective content.
\newblock \emph{Language} 89.66--109.

\bibitem[{Tonhauser et~al.(2019)Tonhauser and
  colleagues}]{tonhauser-etal-sub23}
\textsc{Tonhauser, Judith}; \textsc{Marie-Catherine de~Marneffe};
  \textsc{{Shari R.} Speer}; and \textsc{Jon Stevens}. 2019.
\newblock On the information structure sensitivity of projective content.
\newblock \emph{Sinn und Bedeutung} 23.363--389.

\bibitem[{{van Gelderen}(2004)}]{van-gelderen2004}
\textsc{{van Gelderen}, Elly}. 2004.
\newblock \emph{Grammaticalization as economy}.
\newblock Amsterdam: John Benjamins.

\bibitem[{Vehtari et~al.(2017)Vehtari and colleagues}]{vehtari2017}
\textsc{Vehtari, Aki}; \textsc{Andrew Gelman}; and \textsc{Jonah Gabry}. 2017.
\newblock Practical {B}ayesian model evaluation using leave-one-out
  cross-validation and {W}{A}{I}{C}.
\newblock \emph{Statistics and Computing} 27.1413--1432.

\bibitem[{Watanabe \& Opper(2010)Watanabe and Opper}]{watanabe2010}
\textsc{Watanabe, Sumio}, and \textsc{Manfred Opper}. 2010.
...
\bibitem[{White \& Rawlins(2018)White and Rawlins}]{white-rawlins-nels2018}
\textsc{White, Aaron~S.}, and \textsc{Kyle Rawlins}. 2018.
\newblock The role of veridicality and factivity in clause selection.
\newblock \emph{48th meeting of the {N}orth {E}ast {L}inguistic {S}ociety},
  221--234.

\bibitem[{White(2021)}]{white2021}
\textsc{White, Aaron~Steven}. 2021.
\newblock On believing and hoping whether.
\newblock \emph{Semantics \& Pragmatics} 14.1--18.

\bibitem[{White et~al.(2018)White and colleagues}]{white-etal2018b}
\textsc{White, Aaron~Steven}; \textsc{Rachel Rudinger}; \textsc{Kyle Rawlins};
  and \textsc{Benjamin Van~Durme}. 2018.
\newblock Lexicosyntactic inference in neural models.
\newblock \emph{Proceedings of the 2018 conference on empirical methods in
  natural language processing}, 4717--4724. Brussels, Belgium: Association for
  Computational Linguistics.
\urlprefix\url{https://www.aclweb.org/anthology/D18-1501}.

\bibitem[{Williams et~al.(2018)Williams and colleagues}]{williams-etal2018}
\textsc{Williams, Adina}; \textsc{Nikita Nangia}; and \textsc{Samuel Bowman}.
  2018.
\newblock A broad-coverage challenge corpus for sentence understanding through
  inference.
\newblock \emph{Proceedings of the 2018 conference of the north american
  chapter of the association for computational linguistics: Human language
  technologies}, 1112--1122. Association for Computational Linguistic.

\bibitem[{Wyse(2010)}]{wyse}
\textsc{Wyse, Brendan}. 2010.
\newblock \emph{Factive/non-factive predicate recognition within question
  generation systems}.
\newblock Master's thesis, Open University.

\bibitem[{Xue \& Onea(2011)Xue and Onea}]{xue-onea11}
\textsc{Xue, Jingyang}, and \textsc{Edgar Onea}. 2011.
\newblock Correlation between projective meaning and at-issueness: {A}n
  empirical study.
\newblock \emph{2011 {ESSLLI} Workshop on Projective Content.}, 171--184.

\bibitem[{Zanuttini \& Portner(2003)Zanuttini and
  Portner}]{zanuttini-portner2003}
\textsc{Zanuttini, Raffaella}, and \textsc{Paul Portner}. 2003.
\newblock Exclamative clauses: {A}t the syntax-semantics interface.
\newblock \emph{Language} 79.39--81.
...
\begin{figure}[h!]
\begin{center}
\fbox{\includegraphics[width=10cm]{Language-figures/bw/Figure1}}
\end{center}
...
\includegraphics[width=.7\paperwidth]{Language-figures/bw/Figure2}

\caption{Mean certainty ratings by predicate in Exp.~1a. Error bars indicate 95\% bootstrapped confidence intervals. Violin plots indicate the kernel probability density of the individual participants' ratings.} 
...
\begin{figure}[h!]
\begin{center}
\fbox{\includegraphics[width=10cm]{Language-figures/bw/Figure3}}
\end{center}
...
\centering
\includegraphics[width=.7\paperwidth]{Language-figures/bw/Figure4}
...
\begin{figure}[H]
\centering
\includegraphics[width=.75\paperwidth]{Language-figures/bw/Figure5.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=.77\paperwidth]{Language-figures/bw/Figure6}
...
\begin{figure}[H]
\centering
\includegraphics[width=.77\paperwidth]{Language-figures/bw/Figure7}
...
\begin{figure}[H]
\begin{center}
\fbox{\includegraphics[width=13cm]{Language-figures/bw/Figure8}}
\end{center}
...
\includegraphics[width=.7\paperwidth]{Language-figures/bw/Figure9}

\caption{Mean inference rating by predicate in Exp.~2a, including the nonentailing and entailing controls. Error bars indicate bootstrapped 95\% confidence intervals. Violin plots indicate the kernel probability density of the individual participants' ratings.} 
...
\begin{figure}[h!]
\begin{center}
\fbox{\includegraphics[width=10cm]{Language-figures/bw/Figure10}}
\end{center}
...
\begin{figure}[h!]
\centering
\includegraphics[width=.7\paperwidth]{Language-figures/bw/Figure11}
...
\begin{figure}[h!]
\begin{center}
\fbox{\includegraphics[width=13cm]{Language-figures/bw/Figure12}}
\end{center}
...
\includegraphics[width=.7\paperwidth]{Language-figures/bw/Figure13}

\caption{Mean contradictoriness rating by predicate in Exp.~3a, including the noncontradictory and contradictory controls. Error bars indicate bootstrapped 95\% confidence intervals. Violin plots indicate the kernel probability density of the individual participants' ratings.}
...
\begin{figure}[h!]
\begin{center}
\fbox{\includegraphics[width=10cm]{Language-figures/bw/Figure14}}
\end{center}
...
\begin{figure}[h!]
\centering
\includegraphics[width=.7\paperwidth]{Language-figures/bw/Figure15}
...
\begin{figure}[H]
\centering
\includegraphics[width=.77\paperwidth]{Language-figures/bw/Figure16}
...
\begin{figure}[H]
\centering
\includegraphics[width=.75\paperwidth]{Language-figures/bw/Figure17}
...
\includegraphics[width=\textwidth]{Language-figures/bw/Figure18a}
\caption{One Gaussian component, mean = .4.}
\label{fig:1comp}
\end{subfigure}
\begin{subfigure}{.4\textwidth}
\includegraphics[width=\textwidth]{Language-figures/bw/Figure18b}
...
\begin{subfigure}{.4\textwidth}
\includegraphics[width=\textwidth]{Language-figures/bw/Figure18c}
\caption{Two Gaussian components, mean = .6.}
\label{fig:2comp}
\end{subfigure}
\begin{subfigure}{.4\textwidth}
\includegraphics[width=\textwidth]{Language-figures/bw/Figure18d}
...
\begin{subfigure}{.4\textwidth}
\includegraphics[width=\textwidth]{Language-figures/bw/Figure18e}
\caption{Three Gaussian components.}
\label{fig:reveal}
\end{subfigure} 
\begin{subfigure}{.4\textwidth}
\includegraphics[width=\textwidth]{Language-figures/bw/Figure18f}
