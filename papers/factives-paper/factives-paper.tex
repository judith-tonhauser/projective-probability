...
\subsubsection{Objection 2: Factivity may be a fuzzy category \jt{Perhaps better: The distinction between factive and non-factive predicates might be fuzzy}}
...
The results of our experiments and the meta-analyses of existing datasets did not find empirical support for a class of factive predicates. Our discussion in sections \ref{s-obj1} to \ref{s-obj3} engaged with various ways in which our results might be compatible with a binary factivity category after all. In doing so, the discussion served a dual purpose. First, it highlighted empirical, statistical, and conceptual considerations that future searches for a class of factive predicates should take into consideration. Second, it clarified how the search for a class of factive predicates can continue, for those who wish to maintain such a class.
