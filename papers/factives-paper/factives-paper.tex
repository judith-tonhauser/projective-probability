...
\jd{Describe models} In other words, none of the contradictoriness ratings for the CCs are statistically indistinguishable from those of the controls with indisputably entailed content, suggesting that the CCs of all 20 predicates are not entailed.
...
The critical findings of Exp.~3a were replicated.  \jd{insert model info here once issue of exclusions settled} 
