...
\section{Details on the Bayesian models for Experiments 1 and 2}\label{modeldetails}



\jd{the following itemized list used to be in the results section of exp 1a}

\begin{itemize}

\item give more general explanation of why a beta regression model is appropriate for these data, 
