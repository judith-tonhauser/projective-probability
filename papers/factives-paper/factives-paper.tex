...
\jd{radically clean this up after first paragraph}
...
This is an approach that, it has been suggested to us, lends itself to statistical inquiry via mixture models \jd{insert mixture model ref}. \jd{continue here with mixture model discussion, insert plot} For instance, the data from all the datasets reported in this paper could be analyzed with mixture models for whether the data from a particular predicate is best accounted for by just one component or two. 
