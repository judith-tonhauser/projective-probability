...
%DIF DEL submission-Dec2020/factives-paper.tex   Sat Jun 26 12:39:22 2021
%DIF ADD factives-paper.tex                      Wed Sep 29 10:44:53 2021
...
\paragraph{Entailed.} On the definition in (\ref{def}b), the CC of factive predicates is presupposed and entailed, that is, for a predicate to be factive, its CC must project and also be an indefeasible inference from an affirmative matrix sentence with the predicate. The literature reveals disagreements for many predicates about whether the CC is entailed. \citet[139]{schlenker10}, for instance, \DIFdelbegin \DIFdel{takes }\DIFdelend \DIFaddbegin \DIFadd{took }\DIFaddend the CC of {\em inform} to be entailed and {\em inform} to be a factive predicate: he \DIFdelbegin \DIFdel{assumes }\DIFdelend \DIFaddbegin \DIFadd{assumed }\DIFaddend that Mary being pregnant necessarily follows from (\ref{inform}a). \citet[76]{anand-hacquard2014}, however, \DIFdelbegin \DIFdel{point }\DIFdelend \DIFaddbegin \DIFadd{pointed }\DIFaddend out that {\em inform} can be modified by {\em falsely}, as in the naturally occurring example in (\ref{inform}b), which they \DIFdelbegin \DIFdel{take }\DIFdelend \DIFaddbegin \DIFadd{took }\DIFaddend to show that the CC does not necessarily follow from a true affirmative matrix sentence with {\em inform}; according to them, {\em inform} is not factive. Similarly, \citet{swanson2012} \DIFdelbegin \DIFdel{takes }\DIFdelend \DIFaddbegin \DIFadd{took }\DIFaddend the CC of {\em establish} to be entailed, but the naturally occurring example in (\ref{establish}) again suggests that the CC does not necessarily follow from affirmative matrix sentences with {\em establish}.
...
Other \DIFdelbegin \DIFdel{authors maintain }\DIFdelend \DIFaddbegin \DIFadd{works maintained }\DIFaddend that emotive predicates are factive despite examples like (\ref{emotive}) (e.g., \citealt{gazdar79a,abrusan2011,anand-hacquard2014}): they \DIFdelbegin \DIFdel{hypothesize }\DIFdelend \DIFaddbegin \DIFadd{hypothesized }\DIFaddend that examples like those in (\ref{emotive}) are licensed by a kind of free indirect discourse, that is, do not show that the CC of such predicates is not entailed (or presupposed). 

There is similar disagreement about the cognitive predicate {\em know}: the examples in (\ref{know}) show that the truth of the CC does not necessarily follow from true affirmative matrix sentences with {\em know}. \citet{abrusan2011} \DIFdelbegin \DIFdel{assumes }\DIFdelend \DIFaddbegin \DIFadd{assumed }\DIFaddend that these examples do not show that {\em know} is not factive because ``they are understood as reporting a firm belief or feeling of ``knowledge'' on somebody's part''. Abrus\'an \DIFdelbegin \DIFdel{maintains }\DIFdelend \DIFaddbegin \DIFadd{maintained }\DIFaddend that these examples ``are analogous to the free indirect discourse cases'' (p.515) discussed above.
...
As illustrated, there is no consensus in the literature about which predicates are factive. This lack of consensus is due to differences in how factive predicates are defined and it is compounded by uncertainty about whether projection categorically distinguishes factive predicates from others and by disagreement about whether the CC of particular predicates is entailed. This paper investigates the projection and entailment of the CCs of 20 clause-embedding predicates, with the goal of understanding whether these two properties identify a coherent class of factive predicates. The predicates we investigate are listed in (\ref{pred}) with the categories they are typically taken to fall into\DIFdelbegin \DIFdel{: factive predicates in (\ref{pred}a), non-factive predicates in (\ref{pred}b) and optionally factive predicates in (\ref{pred}c)}\DIFdelend . Specifically, the 5 factive predicates in (\ref{pred}a) include the cognitive predicate {\em know}, the change-of-states predicates {\em discover} and {\em reveal}, the sensory predicate {\em see}, and the emotive predicate {\em be annoyed}. The 6 non-factive predicates in (\ref{pred}b) include 4 `non-veridical non-factive' predicates {\em pretend, suggest, say} and {\em think}, whose CC is typically taken to be neither presupposed nor entailed, as well as  the 2 `veridical non-factive' predicates {\em be right} and {\em demonstrate}, whose CC is typically taken to be entailed but not presupposed.\footnote{\citet{anand-hacquard2014} assumed that {\em demonstrate} is veridical, in contrast to \citealt{anand-etal2019}. This latter work also \DIFdelbegin \DIFdel{takes }\DIFdelend \DIFaddbegin \DIFadd{took }\DIFaddend {\em reveal} to be non-factive, in contrast to, for instance, \citealt{egre2008,wyse} or \citealt{tbd-variability}.}  The 9 optionally factive predicates in (\ref{pred}c) include {\em acknowledge, admit} and {\em announce} (see \citealt{kiparsky-kiparsky70}) as well as {\em confirm, inform, confess, establish, hear} and {\em prove}.\footnote{Different categories have been assumed for these 6 predicates. \citet{anand-hacquard2014} \DIFdelbegin \DIFdel{take }\DIFdelend \DIFaddbegin \DIFadd{took }\DIFaddend {\em confirm} and {\em inform}  to not be factive, while \citet{schlenker10} \DIFdelbegin \DIFdel{takes }\DIFdelend \DIFaddbegin \DIFadd{took }\DIFaddend {\em inform} to be factive. For {\em prove}, \citet{white-rawlins-nels2018} \DIFdelbegin \DIFdel{suggest }\DIFdelend \DIFaddbegin \DIFadd{suggested }\DIFaddend that it is veridical and non-factive, but \citet{anand-hacquard2014} \DIFdelbegin \DIFdel{take }\DIFdelend \DIFaddbegin \DIFadd{took }\DIFaddend it to be non-veridical and non-factive. \citet{swanson2012}  \DIFdelbegin \DIFdel{takes }\DIFdelend \DIFaddbegin \DIFadd{took }\DIFaddend {\em confess} to be factive, while \citet{karttunen2016} only \DIFdelbegin \DIFdel{takes }\DIFdelend \DIFaddbegin \DIFadd{took }\DIFaddend it to commit the speaker to the subject of the attitude being committed to the CC, and \citet{wyse} \DIFdelbegin \DIFdel{lists }\DIFdelend \DIFaddbegin \DIFadd{listed }\DIFaddend it under the non-factive predicates. \citet{swanson2012} \DIFdelbegin \DIFdel{takes  }\DIFdelend \DIFaddbegin \DIFadd{took  }\DIFaddend {\em establish} to be non-factive, but \citet{wyse} \DIFdelbegin \DIFdel{lists }\DIFdelend \DIFaddbegin \DIFadd{listed }\DIFaddend it under the factive predicates. We also included {\em hear}: even though it is often considered a factive predicate (e.g., \citealt{beaver-belly,anand-hacquard2014}), {\em hear} also has a non-factive reportative evidential sense (see, e.g., \citealt{anderson86,simons07}), especially when it is combined with complements that describe events that cannot be auditorily perceived, as in our experiments.}
...
\paragraph{Materials and procedure} The materials and procedure were identical to those of Exp.~1a, with the exception of the task: participants responded `yes' \DIFaddbegin \DIFadd{(coded as 1) }\DIFaddend or `no' \DIFaddbegin \DIFadd{(coded as 0) }\DIFaddend to the question of whether the speaker is certain of the relevant content, as shown in Figure \ref{fig-trial-exp1b}.
...
Figure \ref{f-projectivity2} shows the proportion of `yes' ratings (indicating projection) for the predicates and the main clause stimuli, in increasing order from left to right. Jittered gray dots indicate the individual participants' ratings.\DIFaddbegin \footnote{\DIFadd{Recall that participants gave binary certainty ratings, with `yes' coded as 1 and `no' coded as 0. To increase legibility, these ratings are jittered vertically in Figure \ref{f-projectivity2} and other figures like it. Consequently, the individual certainty ratings should not be read against the y-axis.}} \DIFaddend The order of predicates according to the projection of their CC in Exp.~1b is strikingly similar to that of Exp.~1a, as evidenced by the very high Spearman rank correlation of .983 (see Supplement \ref{a-comparison} for a visualization and details on this correlation). The critical results of Exp.~1a were replicated. First, the CCs of the factive predicates were not categorically more projective than the CCs of the optionally factive predicates:  the CCs of {\em acknowledge, hear} and {\em inform} were again at least as projective as the CCs of {\em reveal} or {\em discover}. Second, a non-arbitrary line between factive and optionally factive predicates cannot be drawn: the CCs of all 20 predicates were projective compared to the non-projective main clause controls.\footnote{According to \citet[1739]{spector-egre2015}, it is not clear whether the CC of {\em say} is projective. The results of our Exps.~1 suggest that it is weakly projective.}  This was established by fitting a Bayesian mixed effects logistic regression model  with weakly informative priors using the \verb|brms| package in R. The model predicted the log odds of a `yes' over a `no' response from a fixed effect of predicate (with treatment coding and `main clause' as  reference level) and included the maximal random effects structure justified by the design, namely random by-participant and by-item intercepts. The estimated log odds of a `yes' response was greater for each predicate than that of the main clause controls, i.e., the 95\% credible intervals for the estimated coefficients did not contain 0 for any predicate. See Supplement \ref{a-mo} for model details. Thus, like Exp.~1a, the results of Exp.~1b do not \DIFdelbegin \DIFdel{support the assumption of the }\DIFdelend \DIFaddbegin \DIFadd{provide support for the }\DIFaddend definition of factive predicates in (\ref{def}a)\DIFdelbegin \DIFdel{that }\DIFdelend \DIFaddbegin \DIFadd{, according to which }\DIFaddend factive predicates are categorically distinguished from optionally factive and non-factive ones by the projection of the CC.
...
\subsection{Interim summary and \DIFdelbegin \DIFdel{alternative analyses}\DIFdelend \DIFaddbegin \DIFadd{converging evidence}\DIFaddend }
\DIFdelbegin %DIFDELCMD < %DIFDELCMD < \label{sec:interimproj}%%%
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \label{s-converging1}
\DIFaddend 

The results of Exps.~1 suggest that projection does not categorically distinguish factive predicates from others\DIFdelbegin \DIFdel{. We observed, }\DIFdelend \DIFaddbegin \DIFadd{: }\DIFaddend contrary to what is expected on definition (\ref{def}a), \DIFaddbegin \DIFadd{we observed }\DIFaddend that the CCs of predicates standardly classified as factive are not categorically more projective than the CCs of all other predicates. \DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{One objection to this conclusion is that the expectation that the CCs of factive predicates should be more projective than those of all other predicates is too strong. Specifically, given that the CCs of factive predicates are among the most projective in both Exps.~1a and 1b, one might argue that to motivate a class of factive predicates it suffices to show that assuming such a class explains  variability observed in the projection of the CCs of clause-embedding predicates. To engage with this possibility, we analyzed the certainty ratings of Exps.~1 in a Bayesian mixed effects Beta regression model (Exp.~1a) and a logistic regression model (Exp.~1b) that predicted projection from a binary factivity predictor, whereby the five predicates in (\ref{pred}a) were classified as factive and the remaining predicates (as well as the main clause controls) as non-factive. We report mean estimates and 95\% credible intervals for the effect of this binary factivity predictor. Under such an analysis of the predicates, the CCs of presumed factive predicates were indeed more projective, both in Exp.~1a ($\beta = 1.49, CI = [1.30, 1.67]$) and in Exp.~1b ($\beta = 3.99, CI = [3.40,4.59]$). It may thus be tempting to conclude that projection-based factivity is a useful category to maintain.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{There are two reasons not to do so. The first is that, as already observed in sections  \ref{s-exp1a} and \ref{s-exp1b}, there is no clear threshold that divides the presumed factive predicates from the others. That is, while the CCs of presumed factive predicates are }\emph{\DIFdel{on average}} %DIFAUXCMD
\DIFdel{more projective than those of other predicates, they are not more projective in comparison with each individual predicate.  Some readers may not be troubled by this and entertain the possibility that factivity is a fuzzy category rather than one with clear boundaries. We discuss this possibility further in section \ref{s4}.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{The second reason not to maintain the category is that the binary factivity models capture less of the variability than the models that include the individual predicates as predictors, which were reported in sections \ref{s-exp1a} and \ref{s-exp1b}. We refer to these latter models as predicate-specific models. Model comparison revealed that predicate-specific models were favored over binary factivity models in both Exp.~1a (WAIC of predicate-specific model: -18971.3 (SE= 359.3); WAIC of binary factivity model: -18643.9 (SE= 355.4))  and Exp.~1b (WAIC of predicate-specific model: 6444.5 (SE= 124.8); WAIC of binary factivity model: 6719.0 (SE= 123.7)).}\footnote{\DIFdel{The Widely Applicable Information Criterion (WAIC) is a measure of model quality that estimates the pointwise out-of-sample prediction accuracy from a fitted Bayesian model using the log-likelihood evaluated at the posterior simulations of the parameter values and penalizes models with more parameters over models with fewer \mbox{%DIFAUXCMD
\citep{watanabe2010}}%DIFAUXCMD
. We obtained WAIC values for each model using the }\texttt{\DIFdel{loo}} %DIFAUXCMD
\DIFdel{package \mbox{%DIFAUXCMD
\citep{vehtari2017}}%DIFAUXCMD
. Lower WAIC values indicate better models.}} %DIFAUXCMD
\addtocounter{footnote}{-1}%DIFAUXCMD
\DIFdel{This suggests that the qualitative observation made in sections  \ref{s-exp1a} and \ref{s-exp1b}, namely that projection variability is better captured by taking into account the individual predicates than a binary factivity classification, is borne out in rigorous model comparison. 
}%DIFDELCMD < 

%DIFDELCMD < %%%
\subsection{\DIFdel{Converging evidence for failure of projection-based definition of factive predicates}}%DIFAUXCMD
\addtocounter{subsection}{-1}%DIFAUXCMD
%DIFDELCMD < %DIFDELCMD < \label{s-converging1}%%%
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{The results of  Exps.~1a and 1b suggest that the definition of factive predicates in (\ref{def}a), according to which a predicate is factive if and only if its CC is presupposed, fails to identify a class of factive predicates. We }\DIFdelend \DIFaddbegin \DIFadd{We }\DIFaddend now discuss converging evidence to this effect from three additional datasets: the CommitmentBank (\citealt*{demarneffe-etal-sub23}), the MegaVeridicality dataset (\citealt{white-rawlins-nels2018,white-etal2018b}) and the VerbVeridicality dataset (\citealt{ross-pavlick2019}).\footnote{We re-plotted the data, obtained at \url{https://github.com/mcdm/CommitmentBank}, \url{http://megaattitude.io} and \url{https://github.com/alexisjihyeross/verb_veridicality}, respectively. For the analysis files, see the GitHub repository mentioned in footnote \ref{f-github}.}
...
A third piece of converging evidence comes from the MegaVeridicality dataset, which contains projection ratings for the CCs of 517 English clause-embedding predicates. The stimuli that participants rated consisted of combinations of these predicates with what \citet{white-rawlins-nels2018} \DIFdelbegin \DIFdel{refer }\DIFdelend \DIFaddbegin \DIFadd{referred }\DIFaddend to as low content arguments, as shown in (\ref{wr-stim-proj}) for {\em know}. The predicates were embedded under negation in stimuli like (\ref{wr-stim-proj}a) and under negation, in the antecedent of a conditional and in a question in stimuli like (\ref{wr-stim-proj}b). To assess projection, participants were asked to respond to the question {\em Did that thing happen?} for stimuli like (\ref{wr-stim-proj}a) and to respond to the question posed by stimuli like (\ref{wr-stim-proj}b). The response options were `yes', `maybe or maybe not' and `no'. 
...
\caption{Proportion of `yes' responses by predicate in Exp.~2b. Error bars indicate 95\% bootstrapped confidence intervals. \DIFdelbeginFL \DIFdelFL{Jittered }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Vertically jittered }\DIFaddendFL light gray dots indicate individual participants' responses of `yes' (coded as 1) and `no' (coded as 0).}
\label{fig:2bresults}
\end{figure}
...
\caption{Proportion of `yes' ratings by predicate in Exp.~3b. Error bars indicate 95\% bootstrapped confidence intervals. \DIFdelbeginFL \DIFdelFL{Jittered }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Vertically jittered }\DIFaddendFL light gray dots indicate individual participants' ratings of `yes' (coded as 1) and `no' (coded as 0). }
\label{fig:3bresults}
\end{figure}
...
%DIF > \subsection{Do projection and entailment jointly identify a class of factive predicates?}\label{s33}
\subsection{\DIFdelbegin \DIFdel{Do projection }\DIFdelend \DIFaddbegin \DIFadd{Interim summary }\DIFaddend and \DIFdelbegin \DIFdel{entailment jointly identify a class of factive predicates?}\DIFdelend \DIFaddbegin \DIFadd{converging evidence}\DIFaddend }\label{s33}
...
If we assume, again, that CCs with mean projection ratings of at least .3 are presupposed, then 92 of the 97 predicates are factive. This set is heterogeneous with respect to projection, including predicates like {\em bother}, with a mean projection rating of .97, {\em inform} (.7), {\em know} (.63), {\em grumble} (.5), {\em notify} (.4), {\em gloat} (.4) {\em convey} (.4) and {\em confirm} (.3). Thus, on the MegaVeridicality set, too, \DIFdelbegin \DIFdel{definition (\ref{def}b) fails to identify a }\DIFdelend \DIFaddbegin \DIFadd{projection and entailment jointly do not identify a coherent }\DIFaddend class of factive predicates.
...
\caption{\DIFaddFL{Mean veridicality rating by predicate in green, with 95\% bootstrapped confidence intervals, for the 517 predicates in the MegaVeridicality dataset (\mbox{%DIFAUXCMD
\citealt{white-rawlins-nels2018,white-etal2018b}}%DIFAUXCMD
), with labels for the 19 predicates featured in our experiments.}}
\label{f-white-rawlins-ent}
\end{figure}

 \DIFaddend This conclusion dovetails with that of \citet{white-rawlins-nels2018}, who assumed definition (\ref{def}b). They pointed out (p.228) that if one were to assume a majority response as threshold for whether the CC is presupposed and entailed, there are 199 factive and 292 non-factive predicates in the MegaVeridicality dataset, but also that ``there are not necessarily clear dividing lines between these classes present in the data, suggesting that speaker's inferences about [projection and entailment; the anonymous authors] are generally quite gradient and likely influenced by the fine-grained semantics
of particular verbs''.

\DIFdelbegin %DIFDELCMD < \begin{figure}[H]
%DIFDELCMD < \centering
%DIFDELCMD < \includegraphics[width=.75\paperwidth]{../../MegaVeridicality-analysis/graphs/means-entailment-by-predicate}
%DIFDELCMD < 

%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Mean veridicality rating by predicate in green, with 95\% bootstrapped confidence intervals, for the 517 predicates in the MegaVeridicality dataset (\mbox{%DIFAUXCMD
\citealt{white-rawlins-nels2018,white-etal2018b}}%DIFAUXCMD
), with labels for the 19 predicates featured in our experiments.}}
%DIFAUXCMD
%DIFDELCMD < %DIFDELCMD < \label{f-white-rawlins-ent}%%%
%DIFDELCMD < \end{figure}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend In sum, contrary to what is expected under the definition of factive predicates in (\ref{def}b), the results of our Exps.~1, 2 and 3, as well as those of the VerbVeridicality and MegaVeridicality datasets, suggest that projection and entailment of the CC do not jointly identify a class of factive predicates. Depending on how entailment is diagnosed and which linking function is assumed, the set of predicates identified as factive is either \DIFaddbegin \DIFadd{empty or }\DIFaddend heterogeneous with respect to projection\DIFdelbegin \DIFdel{or empty}\DIFdelend .

\section{General discussion}\label{s4}

\DIFdelbegin \DIFdel{Despite the central role that factivity has played in linguistic theorizing, there is, as discussed in section \ref{s1}, no agreement in the literature about how factive predicates are defined and which predicates are factive. In sections }\DIFdelend \DIFaddbegin \DIFadd{Sections }\DIFaddend \ref{s2} and \ref{s3} \DIFdelbegin \DIFdel{, we }\DIFdelend reported the results of experiments designed to investigate whether two prevalent definitions\DIFaddbegin \DIFadd{, repeated below, }\DIFaddend identify a class of factive predicates. 
\DIFdelbegin \DIFdel{Our }\DIFdelend \DIFaddbegin 

\begin{exe}
\exi{(\ref{def})} \DIFadd{Two definitions of factive predicates }\\ \DIFadd{A clause-embedding predicate is factive if and only if the content of its clausal complement is 
}\begin{xlist}
\ex \DIFadd{presupposed. }\hfill \DIFadd{(e.g., \mbox{%DIFAUXCMD
\citealt{kiparsky-kiparsky70,karttunen71-implicative,karttunen71b}}%DIFAUXCMD
)
}\ex \DIFadd{presupposed and entailed.  }\hfill \DIFadd{(e.g., \mbox{%DIFAUXCMD
\citealt{gazdar79a,schlenker10,abrusan2011}}%DIFAUXCMD
}\\\DIFadd{\hspace*{.2cm}}\hfill \DIFadd{\mbox{%DIFAUXCMD
\citealt{anand-hacquard2014,spector-egre2015}}%DIFAUXCMD
)
}\end{xlist}
\end{exe}
\DIFadd{The }\DIFaddend experiments in section \ref{s2} investigated the definition in (\ref{def}a)\DIFdelbegin \DIFdel{, according to which a predicate is factive if and only if its CC is presupposed . We found }\DIFdelend \DIFaddbegin \DIFadd{: Assuming projection as a diagnostic for presupposed CCs, the results of these experiments as well as the meta-analyses of three existing datasets suggest }\DIFaddend that projection does not identify a class of factive predicates\DIFdelbegin \DIFdel{and, furthermore, that the CCs of all of the predicates we investigated are at least mildly projective. In section \ref{s3} , we }\DIFdelend \DIFaddbegin \DIFadd{. The experiments in section \ref{s3} }\DIFaddend investigated the definition in (\ref{def}b)\DIFdelbegin \DIFdel{, according to which a predicate is factive if and only if its CC is both presupposed and entailed. We found that , }\DIFdelend \DIFaddbegin \DIFadd{: The evidence from our experiments and meta-analyses of existing datasets suggests that }\DIFaddend depending on how entailment is diagnosed, there \DIFdelbegin \DIFdel{are either }\DIFdelend \DIFaddbegin \DIFadd{either are }\DIFaddend no factive predicates or that the set of predicates identified as factive is heterogeneous with respect to projection, i.e., not a natural class. \DIFdelbegin \DIFdel{We are therefore led to the conclusion that, at present, there is no }\DIFdelend \DIFaddbegin \DIFadd{In sum, the results of our experiments do not provide }\DIFaddend empirical evidence for a \DIFaddbegin \DIFadd{coherent }\DIFaddend class of factive predicates \DIFdelbegin \DIFdel{.
}\DIFdelend \DIFaddbegin \DIFadd{under either of the two definitions in (\ref{def}).
}\DIFaddend 

\DIFdelbegin \DIFdel{This result has implications for linguistic theorizing on any topic in which factivity has played a role, including research on projection, the interpretation of embedded questions, extraction and island effects, control and mood (for more topics and references see section \ref{s1}).
In the remainder of this section, we engage with these implications in one area in which factivity has played a major role, namely projection. Formal }\DIFdelend \DIFaddbegin \DIFadd{Our main motivation in conducting these investigations was to understand which predicates }\DIFaddend analyses of the projection of the CC of clause-embedding predicates \DIFaddbegin \DIFadd{apply to, as these analyses }\DIFaddend are generally limited to the CCs of factive predicates. The explanandum is assumed to be that the CCs of factive predicates, but not those of optionally factive or non-factive ones, are presuppositions, which may project. On some analyses (e.g., \citealt{heim83,vds92}), factive predicates lexically specify that the CC is required to be entailed by or satisfied in the relevant context; optionally factive and non-factive predicates do not carry such a lexical specification. On other analyses (e.g., \citealt{abrusan2011,abrusan2016,romoli2015,best-question}), projection of the CC is derived from the CC being entailed content that is backgrounded; non-entailed CCs of optionally factive and non-factive predicates are again outside of the scope of these analyses. \DIFdelbegin \DIFdel{It is these formal analyses that led us the current investigation: we wanted to understand }\DIFdelend \DIFaddbegin \DIFadd{Given the results of our experiments, we are unfortunately no closer to answering the question of }\DIFaddend which predicates these analyses apply to.\DIFdelbegin \DIFdel{Our conclusion---that there is at present no empirical evidence for a class of factive predicates---challenges long-held and widespread assumptions about clause-embedding predicates and suggests that the domain of application of projection analyses requires rethinking.
}\DIFdelend \DIFaddbegin \footnote{\DIFadd{To be clear: Contemporary analyses of the projection of the CCs of factive predicates can predict the non-projection of factive CCs in particular utterances. For instance, in \mbox{%DIFAUXCMD
\citealt{heim83} }%DIFAUXCMD
and \mbox{%DIFAUXCMD
\citealt{vds92}}%DIFAUXCMD
, the CC is locally accommodated when its projection would result in a contradictory or uninformative utterance. Although projection of the CC does not result in contradictory or uninformative utterances in the stimuli in our Exps.~1, one might assume, as suggested by an anonymous reviewer, a) that some participants enrich the context in which the polar question stimuli were presented with information that does result in a contradiction or uninformativity, and b) that participants are more likely to enrich the context with such information with some factive predicates than others. Under these assumptions, these analyses may be compatible with the results of our Exps.~1, namely that the projection of the CC of factive predicates is heterogeneous and not categorically higher than that of other predicates. Neither assumption, however, strikes us as independently motivated.}} 
\DIFaddend 

\DIFdelbegin \DIFdel{We see two }\DIFdelend \DIFaddbegin \DIFadd{Where do we go from here? There are three broad }\DIFaddend ways forward. \DIFdelbegin \DIFdel{The first one is to reject the conclusion and maintain the assumption that there is a class of factive predicates. One might reject the conclusion on methodological or conceptual grounds. On the former, one might argue that the tasks introduced noise into the response behavior that is independent of the properties of the predicates, or that participants had uncertainty about whether a particular predicate is factive. While both are a possibility,  it is unclear how such arguments could explain the very similar qualitative order of predicates across  Exps. ~1a, 2a, and 3a vs.~1b, 2b, and 3b, respectively.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{One might also reject the conclusion on conceptual grounds. For instance, one might argue that factive predicates should be defined differently altogether and that, consequently, other diagnostics should be used to identify }\DIFdelend \DIFaddbegin \DIFadd{First, one might ask whether there are more appropriate diagnostics for presupposed or entailed content than the ones we have applied, or whether there are more suitable definitions of factive predicates than those in (\ref{def}). Second, one might challenge our conclusion that the results of our investigations do not identify a class of }\DIFaddend factive predicates. \DIFdelbegin \DIFdel{Empirical investigations with such diagnostics would be an important next step for those who want to maintain }\DIFdelend \DIFaddbegin \DIFadd{We engage with several possible objections in  section \ref{s41}. Alternatively, one could give up on }\DIFaddend the assumption that there is a \DIFaddbegin \DIFadd{coherent }\DIFaddend class of factive predicates \DIFaddbegin \DIFadd{(see also \mbox{%DIFAUXCMD
\citealt{karttunen2016} }%DIFAUXCMD
and \mbox{%DIFAUXCMD
\citealt{djaerv-thesis} }%DIFAUXCMD
for such moves). In section \ref{s43}, we discuss what this move would mean for projection analyses}\DIFaddend .
\DIFdelbegin \DIFdel{Alternatively, one might argue that contemporary projection analysescan be made to capture the empirical results while maintaining the current definitions.For instance, analyses like those in \mbox{%DIFAUXCMD
\citealt{heim83} }%DIFAUXCMD
and \mbox{%DIFAUXCMD
\citealt{vds92} }%DIFAUXCMD
recognize that the CCs of factive predicates do not project in specific circumstances: this so-called `local accommodation' of the CC is triggered when }\DIFdelend \DIFaddbegin 


\subsection{\DIFadd{Possible objections}}\label{s41}

\DIFadd{The results of Exps.~1 as well as the meta-analyses of the existing datasets in section \ref{s2} are strongly suggestive of gradience in the }\DIFaddend projection of the \DIFdelbegin \DIFdel{CC would result in a contradictory or uninformative utterance. Although projection of the CC does not result in contradictory or uninformative utterances in the stimuli in our }\DIFdelend \DIFaddbegin \DIFadd{CCs of clause-embedding predicates. Our discussions in sections \ref{s2} and \ref{s3} suggested that this gradience precluded identification of a class of factive predicates on both definitions in (\ref{def}). In the following, we consider several empirical, statistical, and conceptual objections to this conclusion. 
}

\subsubsection{\DIFadd{Objection 1: Noise might have obscured an underlyingly binary factivity category}}\label{s-obj1}

\DIFadd{Our results in }\DIFaddend Exps.~1 \DIFdelbegin \DIFdel{, one might assume, as suggested by an anonymous reviewer, a) that some participants enrich the context }\DIFdelend \DIFaddbegin \DIFadd{are contingent on a particular operationalization of projection -- via the ``certain that'' diagnostic -- and a particular behavioral measurement -- via continuous slider ratings and binary `yes'/`no' judgments. There are multiple ways in which experimental noise might have been introduced and masked an underlying binary factivity category:  i) via the experimental items, which did not consist of the predicates alone, but of sentences }\DIFaddend in which the \DIFdelbegin \DIFdel{polar question stimuli were presented with information that does result in a contradiction or uninformativity, and b) that participants are more likely to enrich the context with such information with some factive predicates than others. Under these assumptions, these analyses may be compatible with the results of our Exps.~1, namely that the projection of the CC of factive predicates is heterogeneous and not categorically higher than that of other predicates.Neither assumption, however, strikes us as independently motivated.The burden of proof lies with those who would maintain analyses that rely on a class of factive predicates }\DIFdelend \DIFaddbegin \DIFadd{predicates were combined with particular subject noun phrases and complement clauses; ii) and which moreover were produced by a named speaker; iii) via the response tasks; and iv) via participant-internal noise. Each of i) to iv) could have introduced systematic noise into the ratings, yielding gradient responses for predicates that may underlyingly be either factive or non-factive}\DIFaddend .

\DIFdelbegin \DIFdel{A second way forward, and the one we advocate for, is to embrace the results reported here and give up the assumption that there is a coherent }\DIFdelend \DIFaddbegin \DIFadd{The experiments reported here were designed to mitigate several possible sources of systematic noise: i) all predicates occurred in the same sentence structures and were combined with the same set of complement clauses across participants; ii) all predicates were presented in utterances situated in the same context; iii) ratings were collected across different tasks; and iv) ratings were obtained from a large number of participants, whose response variability was taken into consideration in the statistical analysis. Reasons to believe that these decisions mitigated noise include the replication in gradient orderings of predicates across continuous (slider ratings) and categorical (selections) response measures (Exp.~1a vs. 1b); the replication of Exp.~1a in Exp.~1 of \mbox{%DIFAUXCMD
\citealt{degen-tonhauser-openmind}  }%DIFAUXCMD
with a Spearman rank correlation of .991; and the replication of gradient orderings of predicates in the meta-analyses of existing datasets, which varied in the experimental tasks and items. We therefore consider it unlikely that experimental noise might have masked an underlying binary factivity category, though there is much need for discussion in the experimental semantics/pragmatics literature about the relation between behavioral data and semantic/pragmatic categories.}\footnote{\DIFadd{For such a discussion in the experimental syntax literature, see \mbox{%DIFAUXCMD
\citealt{lau2014, lau2017, sprouse2007, sprouse2013, hofmeister2010, keller2000, sorace2005}}%DIFAUXCMD
.}}

%DIF > \footnote{For such a discussion in the experimental syntax literature on whether gradience in acceptability judgments reflects underlying gradience in the grammar, see \citealt{lau2014, lau2017, sprouse2007, sprouse2013, hofmeister2010, keller2000, sorace2005}. 

\subsubsection{\DIFadd{Objection 2: The distinction between factive and non-factive predicates might be fuzzy}}

\DIFadd{Another objection to the conclusion that projection does not identify a }\DIFaddend class of factive predicates  \DIFdelbegin \DIFdel{(see also \mbox{%DIFAUXCMD
\citealt{karttunen2016} }%DIFAUXCMD
and \mbox{%DIFAUXCMD
\citealt{djaerv-thesis}}%DIFAUXCMD
). The results of Exps. ~1---that }\DIFdelend \DIFaddbegin \DIFadd{is that the expectation that the CCs of factive predicates should be more projective than those of all other predicates is too strong. Specifically, given that }\DIFaddend the CCs of \DIFdelbegin \DIFdel{many more clause-embedding predicates than previously assumed are projective and that there is a lot of variability in how projective the CCs are---point to several exciting avenues for future research. First, }\DIFdelend \DIFaddbegin \DIFadd{factive predicates are among the most projective in both Exps.~1a and 1b, one might argue that to motivate a class of factive predicates it suffices to show that assuming such a class explains  variability observed in }\DIFaddend the \DIFdelbegin \DIFdel{results suggest that research on projective content has a much broader empirical scope than previously assumed.Given that research on projective content has focused almost entirely on the CC of purportedly factive predicates, to the exclusion of the CC of optionally factive and }\DIFdelend \DIFaddbegin \DIFadd{projection of the CCs of clause-embedding predicates. To engage with this possibility, we analyzed the certainty ratings of Exps.~1 in a Bayesian mixed effects Beta regression model (Exp.~1a) and a logistic regression model (Exp.~1b) that predicted projection from a binary factivity predictor, whereby the five predicates in (\ref{pred}a) were classified as factive and the remaining predicates (as well as the main clause controls) as }\DIFaddend non-factive\DIFdelbegin \DIFdel{ones, our results mean that we are now tasked with investigating and formally analyzing the projection of the CC of }\DIFdelend \DIFaddbegin \DIFadd{. We report mean estimates and 95\% credible intervals for the effect of this binary factivity predictor. Under such an analysis of the predicates, the CCs of presumed factive predicates were indeed more projective, both in Exp.~1a ($\beta = 1.49, CI = [1.30, 1.67]$) and in Exp.~1b ($\beta = 3.99, CI = [3.40,4.59]$). 
}

\DIFadd{A way to ask statistically whether binary factivity is a useful category to posit is to ask how much variability in the data is captured by the binary factivity models compared to the models that include the individual predicates as predictors, which were reported in sections \ref{s-exp1a} and \ref{s-exp1b}. We refer to these latter models as predicate-specific models. Model comparison revealed that predicate-specific models were favored over binary factivity models in both Exp.~1a (WAIC of predicate-specific model: -18971.3 (SE= 359.3); WAIC of binary factivity model: -18643.9 (SE= 355.4))  and Exp.~1b (WAIC of predicate-specific model: 6444.5 (SE= 124.8); WAIC of binary factivity model: 6719.0 (SE= 123.7)).}\footnote{\DIFadd{The Widely Applicable Information Criterion (WAIC) is a measure of model quality that estimates the pointwise out-of-sample prediction accuracy from a fitted Bayesian model using the log-likelihood evaluated at the posterior simulations of the parameter values and penalizes models with more parameters over models with fewer \mbox{%DIFAUXCMD
\citep{watanabe2010}}%DIFAUXCMD
. We obtained WAIC values for each model using the }\texttt{\DIFadd{loo}} \DIFadd{package \mbox{%DIFAUXCMD
\citep{vehtari2017}}%DIFAUXCMD
. Lower WAIC values indicate better models.}} \DIFadd{This suggests that the qualitative observation made in sections  \ref{s-exp1a} and \ref{s-exp1b}, namely that projection variability is better captured by taking into account the individual predicates than a binary factivity classification, is borne out in rigorous model comparison. 
}

%DIF >  ternary waic beta model: 
%DIF >  ternary waic logit model: 6711.3 (SE=124.5)

\subsubsection{\DIFadd{Objection 3: There may be uncertainty about which category a predicate belongs to}}\label{s-obj3}

\DIFadd{It has been suggested to us, in personal communication and by a reviewer, that the observed gradience in projection may be compatible with a binary factivity category in combination with two assumptions: first, that predicates may be ambiguous between }\DIFaddend a \DIFdelbegin \DIFdel{much broader set of clause-embedding predicates than before. One approach to predicting the projection of the CC of optionally factive and non-factive predicates has been to assume that such predicates are ambiguous. \mbox{%DIFAUXCMD
\citet[1736]{spector-egre2015}}%DIFAUXCMD
, for instance, proposed 
that predicates like }%DIFDELCMD < {\em %%%
\DIFdel{tell, predict}%DIFDELCMD < } %%%
\DIFdel{and }%DIFDELCMD < {\em %%%
\DIFdel{announce}%DIFDELCMD < }  %%%
\DIFdel{have a }\DIFdelend factive lexical entry\DIFaddbegin \DIFadd{, }\DIFaddend on which the CC is \DIFdelbegin \DIFdel{entailed and presupposed }\DIFdelend \DIFaddbegin \DIFadd{presupposed and hence projects}\DIFaddend , and a non-factive \DIFdelbegin \DIFdel{one on which it is not . This approach, enhanced with a probabilistic mechanism, is one way of fleshing out the idea raised in section \ref{sec:interimproj}, that factivity may be a fuzzy category: apparent gradience in factivity may be the result of listeners' uncertainty about whether the observed use of a predicate on a particular occasion was intended in its factive or non-factive guise}\DIFdelend \DIFaddbegin \DIFadd{lexical entry on which the CC is not presupposed (for such a proposal for clause-embedding predicates see \mbox{%DIFAUXCMD
\citealt[1736]{spector-egre2015}}%DIFAUXCMD
; for a similar proposal for evaluative adjectives see \mbox{%DIFAUXCMD
\citealt{karttunen-etal2014}}%DIFAUXCMD
); and, second, that interpreters may be uncertain about which lexical entry a speaker intended in their utterance}\DIFaddend . Under such a view, a categorical notion of factivity \DIFdelbegin \DIFdel{on a particular occasion }\DIFdelend is upheld, \DIFdelbegin \DIFdel{but the average effect of the uncertainty experienced by listeners}\DIFdelend \DIFaddbegin \DIFadd{and the observed projection gradience can be hypothesized to be due to listeners' uncertainty }\DIFaddend about the use of \DIFdelbegin \DIFdel{the }\DIFdelend \DIFaddbegin \DIFadd{any given }\DIFaddend predicate, which may be resolved preferentially one way or another through pragmatic factors\DIFdelbegin \DIFdel{, may lead to the result that certain predicates appear generally more factive than others.
This approach has some undesirable properties: for instance, it requires the assumption of widespread ambiguity among clause-embedding predicates and it is unclear which predicates should receive two lexical entries or only one (factive or non-factive). At the same time, it is an approach that lends itself to statistical inquiry}\DIFdelend .
\DIFaddbegin 

%DIF > the average effect of the uncertainty experienced by listeners about the use of any given predicates, which may be resolved preferentially one way or another through pragmatic factors, may lead to the result that certain predicates appear generally more factive than others on average. 

\DIFadd{The suggestion is that one way to test whether it is possible to maintain a binary factivity category with these two assumptions is to fit so-called finite mixture models to the data \mbox{%DIFAUXCMD
\citep{jacobs1991, richardson1997}}%DIFAUXCMD
. These models allow for representing the possibility that multiple components, i.e., multiple sub-datasets, make up an overall dataset. }\DIFaddend For instance, the data \DIFdelbegin \DIFdel{from all the datasets reported in this paper }\DIFdelend \DIFaddbegin \DIFadd{for each predicate from Exp.~1a }\DIFaddend could be analyzed with mixture models \DIFdelbegin \DIFdel{for whether the datafrom a particular predicate is best accounted for by just one component or two. This is an important next step. }%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{However, even if the ambiguity account issupported statistically for at least some predicates, }\DIFdelend \DIFaddbegin \DIFadd{with respect to how many components (one, two, three, four, five, \ldots) best account for }\DIFaddend the \DIFdelbegin \DIFdel{approach cannot account for the observed by-predicate projection variability. For instance, the assumption that both }%DIFDELCMD < {\em %%%
\DIFdel{discover}%DIFDELCMD < } %%%
\DIFdel{and }%DIFDELCMD < {\em %%%
\DIFdel{announce}%DIFDELCMD < } %%%
\DIFdel{have a factive and a }\DIFdelend \DIFaddbegin \DIFadd{data. To illustrate, consider Figure \ref{fig:mixtures}, which shows simulated distributions of certainty ratings together with the optimal number of Gaussian components.}\footnote{\DIFadd{Models were fit using the }\texttt{\DIFadd{mclust}} \DIFadd{and }\texttt{\DIFadd{mixtools}} \DIFadd{packages \mbox{%DIFAUXCMD
\citep{benaglia2009, scrucca2016}  }%DIFAUXCMD
in R.}} \DIFadd{Given the aforementioned assumptions, one could attribute certainty ratings that are best captured with one Gaussian component with a mean of .4, as in panel (a), to a predicate that only has a }\DIFaddend non-factive \DIFdelbegin \DIFdel{lexical entry does not on its own predict that the CC of }%DIFDELCMD < {\em %%%
\DIFdel{discover}%DIFDELCMD < } %%%
\DIFdel{is more projective than }\DIFdelend \DIFaddbegin \DIFadd{lexical entry. Likewise, one could attribute certainty ratings that are best captured with one Gaussian component with a mean of .85, as in panel (b), to a predicate that only has a factive lexical entry.  Certainty ratings like those in panels (c) and (d), which are best captured by two Gaussian components, might then be attributed to predicates that have both a factive and a non-factive lexical entry, with differences between (c) and (d) being due to the predicates interacting differently with pragmatic factors that modulate projection. The projection gradience observed in Exp.~1a could be hypothesized to come about by virtue of one or two components being combined in various ways. 
}
...
%DIF > In light of this evidence, we would like to quote from \citealt{wasow2007}, who already made our argument for us, albeit in the domain of gradience in the grammar:  ``At a minimum, those who argue that all gradience in language should be relegated to performance should embed their grammatical theories in theories of performance that are sufficiently explicit to make testable predictions. More generally, most linguists treat the assumption that grammars are categorical as the null hypothesis; but there is no basis for this assumption. The manifestly gradient nature of so many observable linguistic phenomena naturally suggests that theories of them should include a quantitative component''  (p.~269, \citealt{wasow2007}). Thus: ``Advocates of excluding gradience from grammar have tradition on their side, but the burden of proof is nevertheless on them'' (p.~269, \citealt{wasow2007}).

%DIF > A third way forward was suggested to us in personal communication at conferences and by a reviewer: fitting alternative models to the data, namely so-called mixture models, to understand whether the observed gradience can be attributed to a binary factivity category. We engage with this suggestion in section \ref{s42}, but ultimately conclude that the application of such models are not a fruitful way forward.
%DIF > 
%DIF > \jt{the following needs to be integrated}

%DIF > Gradient vs categorical representations in syntax:
%DIF > \begin{itemize}
%DIF > 	\item ``speakers represent grammatical well-formedness as a gradient property'' \cite{lau2014}
%DIF > 	\item "We tested a large number of speakers through (filtered) crowd sourcing, with three distinct modes of classification, one binary and
%DIF > two ordered scales. We found a high degree of correlation in mean judgements for sentences across the three classification tasks. " \cite{lau2014}
%DIF > 	\item "As Armstrong, Gleitman, and Gleitman (1983)
%DIF > show, under some experimental conditions, subjects will rate some odd numbers as being more typically odd than others.
%DIF > The fact that we have gradient results for individual judgements may not, in itself, be evidence for an underlying gradient category" \cite{lau2014}
%DIF > 	\item "Acceptability judgements are intrinsically gradient. There is widespread agreement on this claim, and we have demonstrated it with a range of experimental evidence. This claim does not, in itself, exclude a binary formal grammar. However, it does require that if one is to sustain a binary view of grammatical competence, then one must supplement it with additional performance factors that produce the observed distribution of acceptability judgements. To the extent that an alternative theory that incorporates gradience directly into linguistic competence is able to predict the range of observed speakers' judgements, it enjoys empirical support not available for an, as yet, unformulated and untested analysis which combines a categorical grammar with additional performance factors. Our language modeling work indicates that enriched probabilistic models predict observed human acceptability judgements to an encouraging degree of accuracy." \cite{lau2017}
%DIF > 	\item "extra-grammatical factors that
%DIF > affect the acceptability and are predicated on the existence of a representation, such as syntactic priming should not affect the acceptability of ungrammatical sentences.... results from Sprouse (2007) that confirm this prediction: Ungrammatical sentences, in particular island
%DIF > violations (Ross 1967), do not show a structural priming effect" \cite{sprouse2007}
%DIF > 	\item "After considering whether the \textbf{burden of proof} belongs properly with the advocates or opponents of gradient grammatical theories, I survey several studies suggesting that speakers' knowledge of language includes knowledge not just of cooccurrence possibilities, but of cooccurrence probabilities. This argues for a gradient conception of grammar." \cite{wasow2007}
%DIF > 	\item "At a minimum, those
%DIF > who argue that all gradience in language should be relegated to performance
%DIF > should embed their grammatical theories in theories of performance that
%DIF > sufficiently explicit to make testable predictions.
%DIF > More generally, most linguists treat the assumption that grammars are
%DIF > categorical as the null hypothesis; but there is no basis for this assumption. The
%DIF > manifestly gradient nature of so many observable linguistic phenomena naturally
%DIF > suggests that theories of them should include a quantitative component" \cite{wasow2007}
%DIF > \item "Advocates of excluding gradience from grammar
%DIF > have tradition on their side, but the burden of proof is nevertheless on them. " \cite{wasow2007}
%DIF > 	\item advocates for gradience in grammar: \cite{keller2000,sorace2005,lau2014,lau2017,wasow2007}
%DIF > 	\item against gradience in grammar: \cite{sprouse2007,sprouse2013, hofmeister2010}, eg, gradience might arise as the result of performance factors (but no spelling out of details, as pointed out by lau et al, wasow)
%DIF > 	\item probabilistic models of projection to build on \cite{qing2016, stevens-etal2017}
%DIF > \end{itemize}




%DIF > But it is still a possibility that there is a binary factivity category, namely if the category has fuzzy rather than fixed boundaries. One way to make this explicit is to assume that predicates are ambiguous between a factive and a non-factive lexical entry, and that interpreters may be uncertain about which lexical entry a speaker intended in their utterance. \citet[1736]{spector-egre2015}, for instance, proposed that predicates like {\em tell, predict} and {\em announce}  have a factive lexical entry on which the CC is entailed and presupposed, and a non-factive one on which it is not. 

\subsection{\DIFadd{Implications for projection analyses}}\label{s43}
...
\DIFadd{But even in the absence of a conclusive list of factive predicates, the results of our Exps.~1 as well as the meta-analyses of the three existing datasets point to exciting avenues for future research on projective content. First, our results show that the CCs of many more clause-embedding predicates than previously assumed are projective. This suggests that research on projective content has a much broader empirical scope than previously assumed. Given that research on projective content has focused almost entirely on }\DIFaddend the CC of  \DIFdelbegin %DIFDELCMD < {\em %%%
\DIFdel{announce}%DIFDELCMD < }%%%
\DIFdelend \DIFaddbegin \DIFadd{factive predicates, to the exclusion of the CC of other clause-embedding predicates, our results mean that we are now tasked with investigating and formally analyzing the projection of the CC of a much broader set of clause-embedding predicates than before}\DIFaddend . Research on projective content has identified several factors that influence the projection of utterance content, including context, lexical content, prior \DIFdelbegin \DIFdel{content probability}\DIFdelend \DIFaddbegin \DIFadd{beliefs}\DIFaddend , at-issueness, information structure\DIFaddbegin \DIFadd{, }\DIFaddend and the perceived degree of reliability and trustworthiness of the attitude holder (e.g., \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citealt{gazdar79a,gazdar79b,beaver-belly,schlenker10,brst-salt10,best-question,abrusan2011,abrusan2016,anand-hacquard2014,cummins-rohde2015,djaerv-bacovcin-salt27,mahler-etal2020,mahler2020,tonhauser-salt26,tonhauser-guarani-variability,tbd-variability,tonhauser-etal-sub23}}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citealt{gazdar79a,gazdar79b,beaver-belly,schlenker10,brst-salt10,best-question,abrusan2011,abrusan2016,anand-hacquard2014,cummins-rohde2015,djaerv-bacovcin-salt27,mahler-etal2020,mahler2020,tonhauser-salt26,tonhauser-guarani-variability,tbd-variability,tonhauser-etal-sub23,degen-tonhauser-openmind}}%DIFAUXCMD
}\DIFaddend ). An exciting question for future research is whether these factors are implicated in the projection of the CCs of all clause-embedding predicates, or only of particular subsets, and how they contribute to the observed projection variability between clause-embedding predicates. A framework that offers a principled mechanism for modeling the probabilistic interaction of factors like lexical \DIFdelbegin \DIFdel{uncertainty with speaker reliability}\DIFdelend \DIFaddbegin \DIFadd{content, speaker reliability, }\DIFaddend and prior beliefs about likely meanings is the Rational Speech Act (RSA) framework \citep{bergen2016}. We believe that implementing the interpretation of utterances with clause-embedding predicates in RSA offers a promising way forward. 

\DIFaddbegin \DIFadd{Second, our results show that there is a lot of variability in how projective the CCs of the different clause-embedding predicates are. }\DIFaddend One of the factors that clearly plays a role in predicting projection variability is the lexical meaning of the clause embedding predicate. \DIFdelbegin \DIFdel{As shown by our }\DIFdelend \DIFaddbegin \DIFadd{Our }\DIFaddend Exps.~1, as well as \DIFdelbegin \DIFdel{by \mbox{%DIFAUXCMD
\citealt{tbd-variability} }%DIFAUXCMD
and \mbox{%DIFAUXCMD
\citealt{demarneffe-etal-sub23}}%DIFAUXCMD
, }\DIFdelend \DIFaddbegin \DIFadd{the results presented in \mbox{%DIFAUXCMD
\citealt{tbd-variability,demarneffe-etal-sub23} }%DIFAUXCMD
and \mbox{%DIFAUXCMD
\citealt{degen-tonhauser-openmind}}%DIFAUXCMD
, suggest that }\DIFaddend a binary distinction between factive and non-factive predicates is too coarse to adequately predict projection. We hypothesize that more fine-grained distinctions that are based on the lexical meaning and discourse use of clause-embedding predicates are critical; specifically, we hypothesize that the CCs of classes of predicates that share lexical meanings and discourse uses are similar in projection.\DIFaddbegin \footnote{\DIFadd{Similarly, \mbox{%DIFAUXCMD
\citealt{white2021} }%DIFAUXCMD
recently proposed that lexical semantic properties other than factivity may be implicated in another domain where factivity has been taken to play a role, namely whether a predicate is responsive.}}
 \DIFaddend 
...
Linguistic research since \citealt{kiparsky-kiparsky70} has assumed that properties of the content of the clausal complement distinguish factive predicates from others. This paper investigated whether the content of the complement of 20 English clause-embedding predicates is projective and entailed, with the goal of identifying whether there is a class of factive predicates according to two definitions found in the literature. Our experiments revealed that projection alone does not categorically distinguish factive predicates from others, and that a \DIFaddbegin \DIFadd{coherent }\DIFaddend class of factive predicates also does not emerge from the additional consideration of entailment, as assessed by two standard diagnostics. \DIFdelbegin \DIFdel{We conclude that there is, at present, no empirical support for the assumed categorical factivity distinction. This calls for a reassessment of projection analyses that are limited to the content of the complement of factive predicates , and also opens }\DIFdelend \DIFaddbegin \DIFadd{In addition to considering how the search for a class of factive predicates might continue, we also suggested that our results open }\DIFaddend up several exciting new avenues for empirical and theoretical research on the projection of the contents of the complements of clause-embedding predicates.
...
\section{\DIFadd{Mixture models applied to data from Exp.~1a}}\label{a-gaussian}

\DIFadd{Figure \ref{fig:mixtures-exp1a} plots the density of certainty ratings for the 20 predicates from Exp.~1a with the number of Gaussian components overlaid.
}
...
\includegraphics[width=\textwidth]{../../results/5-projectivity-no-fact/graphs/mixtures/pretend-gaussian}
\caption{{\em \DIFadd{pretend}}\DIFadd{, 2 components.}}
\label{fig:1comp}
\end{subfigure} \begin{subfigure}{.19\textheight}
\includegraphics[width=\textwidth]{../../results/5-projectivity-no-fact/graphs/mixtures/be-right-gaussian}
\caption{{\em \DIFadd{be right}}\DIFadd{, 3 components.}}
\label{fig:1comp}
\end{subfigure} 
\begin{subfigure}{.19\textheight}
\includegraphics[width=\textwidth]{../../results/5-projectivity-no-fact/graphs/mixtures/think-gaussian}
\caption{{\em \DIFadd{think}}\DIFadd{, 4 components.}}
\label{fig:1comp}
\end{subfigure}
\begin{subfigure}{.19\textheight}
\includegraphics[width=\textwidth]{../../results/5-projectivity-no-fact/graphs/mixtures/suggest-gaussian}
\caption{{\em \DIFadd{suggest}}\DIFadd{, 2 components.}}
\label{fig:1comp}
\end{subfigure}
\begin{subfigure}{.19\textheight}
\includegraphics[width=\textwidth]{../../results/5-projectivity-no-fact/graphs/mixtures/say-gaussian}
\caption{{\em \DIFadd{say}}\DIFadd{, 5 components.}}
\label{fig:1comp}
\end{subfigure}

\begin{subfigure}{.19\textheight}
\includegraphics[width=\textwidth]{../../results/5-projectivity-no-fact/graphs/mixtures/prove-gaussian}
\caption{{\em \DIFadd{prove}}\DIFadd{, 3 components.}}
\label{fig:1comp}
\end{subfigure}
\begin{subfigure}{.19\textheight}
\includegraphics[width=\textwidth]{../../results/5-projectivity-no-fact/graphs/mixtures/confirm-gaussian}
\caption{{\em \DIFadd{confirm}}\DIFadd{, 2 components.}}
\label{fig:1comp}
\end{subfigure}
\begin{subfigure}{.19\textheight}
\includegraphics[width=\textwidth]{../../results/5-projectivity-no-fact/graphs/mixtures/establish-gaussian}
\caption{{\em \DIFadd{establish}}\DIFadd{, 6 components.}}
\label{fig:1comp}
\end{subfigure}
\begin{subfigure}{.19\textheight}
\includegraphics[width=\textwidth]{../../results/5-projectivity-no-fact/graphs/mixtures/demonstrate-gaussian}
\caption{{\em \DIFadd{demonstrate}}\DIFadd{, 5 components.}}
\label{fig:1comp}
\end{subfigure}
\begin{subfigure}{.19\textheight}
\includegraphics[width=\textwidth]{../../results/5-projectivity-no-fact/graphs/mixtures/announce-gaussian}
\caption{{\em \DIFadd{announce}}\DIFadd{, 5 components.}}
\label{fig:1comp}
\end{subfigure}

\begin{subfigure}{.19\textheight}
\includegraphics[width=\textwidth]{../../results/5-projectivity-no-fact/graphs/mixtures/confess-gaussian}
\caption{{\em \DIFadd{confess}}\DIFadd{, 6 components.}}
\label{fig:1comp}
\end{subfigure}
\begin{subfigure}{.19\textheight}
\includegraphics[width=\textwidth]{../../results/5-projectivity-no-fact/graphs/mixtures/admit-gaussian}
\caption{{\em \DIFadd{admit}}\DIFadd{, 4 components.}}
\label{fig:1comp}
\end{subfigure}
\begin{subfigure}{.19\textheight}
\includegraphics[width=\textwidth]{../../results/5-projectivity-no-fact/graphs/mixtures/reveal-gaussian}
\caption{{\em \DIFadd{reveal}}\DIFadd{, 4 components.}}
\label{fig:1comp}
\end{subfigure}
\begin{subfigure}{.19\textheight}
\includegraphics[width=\textwidth]{../../results/5-projectivity-no-fact/graphs/mixtures/acknowledge-gaussian}
\caption{{\em \DIFadd{acknowledge}}\DIFadd{, 4 components.}}
\label{fig:1comp}
\end{subfigure}
\begin{subfigure}{.19\textheight}
\includegraphics[width=\textwidth]{../../results/5-projectivity-no-fact/graphs/mixtures/hear-gaussian}
\caption{{\em \DIFadd{hear}}\DIFadd{, 4 components.}}
\label{fig:1comp}
\end{subfigure}

\begin{subfigure}{.19\textheight}
\includegraphics[width=\textwidth]{../../results/5-projectivity-no-fact/graphs/mixtures/discover-gaussian}
\caption{{\em \DIFadd{admit}}\DIFadd{, 4 components.}}
\label{fig:1comp}
\end{subfigure}
\begin{subfigure}{.19\textheight}
\includegraphics[width=\textwidth]{../../results/5-projectivity-no-fact/graphs/mixtures/inform-gaussian}
\caption{{\em \DIFadd{inform}}\DIFadd{, 4 components.}}
\label{fig:1comp}
\end{subfigure}
\begin{subfigure}{.19\textheight}
\includegraphics[width=\textwidth]{../../results/5-projectivity-no-fact/graphs/mixtures/see-gaussian}
\caption{{\em \DIFadd{see}}\DIFadd{, 3 components.}}
\label{fig:1comp}
\end{subfigure}
\begin{subfigure}{.19\textheight}
\includegraphics[width=\textwidth]{../../results/5-projectivity-no-fact/graphs/mixtures/know-gaussian}
\caption{{\em \DIFadd{know}}\DIFadd{, 3 components.}}
\label{fig:1comp}
\end{subfigure}
\begin{subfigure}{.19\textheight}
\includegraphics[width=\textwidth]{../../results/5-projectivity-no-fact/graphs/mixtures/be-annoyed-gaussian}
\caption{{\em \DIFadd{be annoyed}}\DIFadd{, 3 components.}}
\label{fig:1comp}
\end{subfigure}

\caption{\DIFadd{Histograms of certainty ratings from Exp.~1a with overlaid optimal number of Gaussian components.}}
