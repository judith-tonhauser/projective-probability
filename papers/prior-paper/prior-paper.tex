...
\paragraph{Data exclusion} Data was excluded based on self-declared non-native speaker status and other criteria given in Supplement \ref{a-exclusion}, leaving %7,436 with critical and filler trials, but these already used for data exclusion, so leave out of reported number
...
\paragraph{Data exclusion} We excluded data based on the criteria given in Supplement \ref{a-exclusion}, leaving data from 75 participants to be analyzed in Exp.~2a (1,500 data points%\jt{with controls: 1650}
; ages 21-75; median: 35; 34 female, 41 male) and from 266 participants in Exp.~2b (5,320 data points% \jt{with controls: 6,916}
