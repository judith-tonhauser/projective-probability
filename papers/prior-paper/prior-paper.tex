...
We begin by addressing the research question of whether prior probability influences projection. As expected, there is both by-participant and by-content variability in prior probability ratings: this is shown in Figure \ref{f-prior}, which plots the participants' ratings for the contents of the 20 clauses by fact in light dots together with the mean prior probabilities.
