...
\centering
\fbox{\includegraphics[width=7cm]{figures/exp1-projection-trial}} 
\caption{Projection block}\label{fig-exp1-projection}
 \end{subfigure}%
\begin{subfigure}[t]{0.5\textwidth}
        \centering
\fbox{\includegraphics[width=6.7cm]{figures/exp1-prior-trial}}
...
\caption{Mean likelihood ratings by clause and fact in Exp.~1. Error bars indicate 95\% bootstrapped confidence intervals. Light dots indicate participants' ratings.} 
\label{f-projection}
\end{figure}
...
\includegraphics[width=.75\paperwidth]{../../results/exp4/graphs/projectivity-by-prior-and-predicate}
...
\caption{Mean likelihood ratings by content and fact in Exp.~2. Error bars indicate 95\% bootstrapped confidence intervals. Light dots indicate participants' ratings.}
\label{f-prior}
\end{figure}
