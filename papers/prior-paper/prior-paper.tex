...
Before addressing the research question of whether prior probability influences projection, we inspect the prior probability ratings obtained for the content of each of the 20 clauses. Figure \ref{f-prior} plots the mean prior probability of the content of each of the 20 clauses by fact. The light dots indicate participants' ratings. As shown, participants on average rated the prior probability of a content to be higher when the content was presented with the higher probability fact than when the content was presented with the lower probability fact. There is both by-participant and by-content variability in prior probability ratings, suggesting that participants' beliefs influences prior probability ratings.
...
We now turn to the research question of whether prior probability influences projection. Figure \ref{f-projection} shows, for each of the 20 clause-embedding predicates, the participants' certainty ratings of the content of the clausal complement by their prior probability rating. Linear smoothers with 95\% confidence intervals are overlaid. As shown, there is a positive correlation between prior probability ratings and certainty ratings for the contents of the complements of all 20 clause-embedding predicates such that contents with higher prior probability ratings receive higher certainty ratings. This finding suggests that prior probability influences projection.
