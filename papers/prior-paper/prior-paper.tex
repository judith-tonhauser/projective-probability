...
\jt{what do we do with the graphs.R and analysis.R material that we don't need for this paper, but have used e.g. for XPRAG talk or other talks?}
...
\paragraph{Data exclusion} Data was excluded based on self-declared non-native speaker status and other criteria given in Supplement \ref{a-exclusion}, leaving 5,720 prior and projection data points each \jt{7,436 with controls/fillers} from 286 participants to be analyzed (ages 18-82; median: 35.5; 116 female, 186 male, 1 other, 1 undeclared).
...
\paragraph{Data exclusion} We excluded data based on the criteria given in Supplement \ref{a-exclusion}, leaving data from 75 participants to be analyzed in Exp.~2a (1,500 data points \jt{with controls: 1650}; ages 21-75; median: 35; 34 female, 41 male) and from 266 participants in Exp.~2b (5,320 data points \jt{with controls: 6,916}; ages 21-72; median: 36; 129 female, 136 male, 1 undeclared).
