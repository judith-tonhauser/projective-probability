...
We tested whether listeners' prior beliefs modulate projection, a question that has started to be explored, albeit with conflicting results \cite{mahler2020, lorson2018}. The results reported here confirm \citepos{mahler2020} results and expand on them in several ways. First, while \citeNP{mahler2020} manipulated only the political party affiliation of the speaker, the manipulation in Exps.~1 and 2 relied on 20 distinct properties of the individuals denoted by the subjects of the 20 clauses (e.g., whether Julian is more likely to dance salsa if he is German or Cuban). Thus, the result of Exps.~1 and 2 suggests a general effect of prior beliefs on projection. Second, our experiments show that prior beliefs modulate projection for a wider cross-section of clause-embedding predicates, including cognitive (e.g., {\em know}), emotive (e.g., {\em be annoyed}), communication (e.g., {\em announce}), and inferential (e.g., {\em prove}) predicates. Finally, the within-participant design of Exp.~1 allowed us to show that individuals' prior beliefs better predict projection than group-level beliefs, which in turn better predict projection than the binary categorical beliefs that \citeNP{mahler2020} investigated. This result suggests that at least some by-participant variability observed in previous projection experiments (see, e.g., \citeNP{tbd-variability,tonhauser-degen-factive}) may be due to participants assigning different prior probabilities to the contents under investigation. The result further suggests that theories of meaning must take into consideration that listeners have beliefs about the world and the speaker and that listeners differ in these beliefs.
